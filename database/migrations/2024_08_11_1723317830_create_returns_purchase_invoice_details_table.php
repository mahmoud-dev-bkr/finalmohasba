...
class CreateReturnsPurchaseInvoiceDetailsTable extends Migration
{
    public function up()
    {
        Schema::create('returns_purchase_invoice_details', function (Blueprint $table) {

		$table->bigIncrements('id');
		$table->integer('product_id')->nullable();
		$table->integer('purchase_invoice_id')->nullable();
		$table->integer('qun')->nullable();
		$table->string('withDescunt')->default('off');
		...
		$table->integer('qunXunit')->nullable();
    ...
    {
        Schema::dropIfExists('returns_purchase_invoice_details');
    }
}