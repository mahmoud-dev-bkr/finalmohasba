@extends('layouts.vertical', ['title' => 'اضافة موظف'])
@section('content')
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">تعريف الموظف</button>
                        </li>
                        <li class="nav-item" role="presentation">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 my-3">
                                        <div class="form my-5 py-5 ">
                                            ...
                                            <div class="d-flex align-content-center justify-content-around">
                                                <label class="mt-3 ml-5">
                                                    الموقع الخاص بالموظف
                                                </label>
                                                <select class="form-control w-50 my-3" name="site_id" id="" >
                                                    <optgroup>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            <p class="be-small text-secondary">في هذا القسم ، ستحدد مكونات الراتب
                                                للموظف ، بينما يمكنك حفظ الموظف دون ملء هذه الحقول ، لن نتمكن من
                                                إصدار دفعات أو وضع هذا الموظف في كشوف المرتبات.</p>
