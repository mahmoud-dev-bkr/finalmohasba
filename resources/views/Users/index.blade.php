                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex pt-5 justify-content-sm-center">
                                            ...
                                            <input class="form-control mx-2" style="width:15%;" type="text"
                                                placeholder="الاسم الاول">
                                            <input class="form-control form-control-sm mx-2" style="width:15%;"
                                                type="text" placeholder="اسم العائلة">
                                            <input class="form-control form-control-sm mx-2" style="width:15%;"
                                                type="text" placeholder="البريدالالكتروني">

                                            <select class="form-control form-control-sm" style="width:15%;" name=""
                                                id="">
                                                <optgroup>
                                            ...
                                            <button class="btn btn-primary mx-2" style="width:15%;"><i
                                                    class="fa-solid fa-magnifying-glass"></i> بحث</button>
                                            <button onclick="reset()" class="btn btn-dark mx-1" style="width:15%;"><i
