@extends('layouts.vertical', ['title' => 'الخصومات'])
@section('content')
      <div class="container-fluid">
        ...
        <section id="content-wrapper" class="content-header">
            ...
            <section>
                <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2">  <a href=""{{ route('discount.create') }}"" class="text-light">خصم جديد</a> <i class="fa-solid fa-plus"></i></button>
                </div>
               <div class="container my-3">
                <div class="row">
                    <div class="col-md-12 hi-mohasba">

                        <h4 class="mx-4">الخصومات</h4>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="responsive-scroll">
                                    <table id="discountTable" class="table text-center">
                ...
                <div class="row bg-light pb-4 brdr">
                    ...
                    <div class="col-md-12 clients ">
                       ...
                       <div>
                           <img src="{{ URL('images/discount.svg') }}"  alt="">
                           <h1 class="my-2">ليس لديك أي خصومات</h1>
                           ...
                           <button class="btn btn-primary mx-2 "> <a href="{{ route('discount.create') }}" class="text-light"> خصم جديد</a>  <i class="fa-solid fa-plus"></i></button>
                       </div>
...
@section('script')
    ...
    <script>
        ...
        function setdiscountDatatable() {
            var url = "{{ route('getdiscountData') }}";
