@extends('layouts.vertical', ['title' => 'تعديل سندات العميل'])
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="purchase-orders.html"> سندات العميل</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-purch-order.html"> تعديل سندات العميل </a>
                    </li>
                </ul>
            </div>
    ...
    <section>
        ...
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <form action="{{ route('Clientbond.edit', $Clientbond->id) }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> المرجع</label><input value="{{ $Clientbond->code }}" name="code" type="text" class="form-control w-75 my-2">
                                </div>

                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">الوصف</label><input value="{{ $Clientbond->Note }}" name="Note" type="text" class="form-control w-75 my-2">
                                </div>

                                <div class="d-flex align-content-center justify-content-sm-between my-3">
                                    <label class="mt-3 ml-5">العميل</label>
                                    <select  class="form-control w-75" name="id_customers" id="">
                                        <optgroup>
                                            <option value="30">اختار عميل</option>
                                            @foreach ($Clients as $Client )
                                                <option {{ $Clientbond->id_customers == $Client->id ? 'selected' : ''}} value="{{ $Client->id }}">{{ $Client->name }}</option>
                                            @endforeach
                                        </optgroup>
                                    </select>
                                </div>
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input value="{{ $Clientbond->Date }}" name="Date" type="date" class="form-control w-75 my-2">
                                </div>
                                ...
                                <select  class="form-control w-75" name="id_Account" id="">
                                    <optgroup>
                                        ...
                                        @foreach ($accounts as $account )
                                            <option {{ $Clientbond->id_Account == $account->id ? 'selected' : '' }} value="{{ $account->id }}">{{ $account->name }}</option>
                                        @endforeach
                                    </optgroup>
                                </select>
                                </div>
                                ...
                                <select  class="form-control w-75" name="type" id="">
                                    <optgroup>
                                        <option {{ $Clientbond->type == 1 ? 'selected' : '' }} value="1">قبض</option>
                                        <option {{ $Clientbond->type == 0 ? 'selected' : '' }} value="0">صرف</option>
                                    </optgroup>
                                </select>
                                </div>

                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">القيمة</label><input type="text" value="{{ $Clientbond->Amount }}" name="Amount"
