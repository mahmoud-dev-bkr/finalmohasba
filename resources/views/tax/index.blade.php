@extends('layouts.vertical', ['title' => ' الضريبة'])
@section('content')
      <div class="container-fluid">
        ...
        <section id="content-wrapper" class="content-header">
            <div class="row">
                  ...
                  <li class="text-primary">
                    <i class="fa fa-angle-double-left mx-2 "></i><a href=""> الضريبة</a>
                    </li>
                  </ul>
                  </div>
            ...
            <section>
                <div class="d-flex justify-content-sm-end mx-5 employers">
                    <button class="btn btn-primary mx-2">  <a href="{{ route('tax.create') }}" class="text-light">اضافة الضريبة</a> <i class="fa-solid fa-plus"></i></button>
                ...
                <div class="row bg-light pb-4 brdr">
                    ...
                    <div class="col-md-12 clients ">
                       ...
                       <div>
                           ...
                           <h1 class="my-3">ليس لديك أي ضريبة</h1>
                           ...
                           <button class="btn btn-primary mx-2 "> <a href="" class="text-light">اضافة اهلاك</a>  <i class="fa-solid fa-plus"></i></button>
                       </div>
