@extends('layouts.vertical', ['title' => ' ضريبة  جديد'])
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <ul class="d-flex align-content-center">
                                            ...
                                            <i class="fa fa-angle-double-left mx-2 "></i><a href="fixed-assets.html"> الضرائب </a>
                                            </li>
                                            <li class="text-primary">
                                              <i class="fa fa-angle-double-left mx-2 "></i><a href="">لضريبة جديد</a>
                                              </li>
                                            </ul>
                                    </div>
                                ...
                                <div class="row bg-light pb-4 brdr">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-7">
                                        ...
                                        <form action="{{ route('tax.create.post') }}" method="post">
                                                @csrf
                                            ...
                                            <div class="d-flex align-content-center justify-content-around my-3">
                                                ...
                                                <div class="d-flex align-content-center justify-content-around">
                                                    <label class="mt-3 ">  الاسم العربي </label><input type="text" name="name_ar" class="form-control w-50 my-2">
                                                    </div>

                                                    <div class="d-flex align-content-center justify-content-around">
                                                        <label class="mt-3 ">  الاسم الانجليزي </label><input type="text" name="name_en" class="form-control w-50 my-2">
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-content-center justify-content-around">
                                                            <label class="mt-3 ">  النسبة  </label><input type="text" name="rotio" class="form-control w-50 my-2">
                                                            </div>
