...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-3">
                    <ul class="d-flex align-content-center">
                        ...
                        <li class="text-dark">
                            <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('sales_invoices.index') }}">
                                فواتير مبيعات</a>
                        </li>
        ...
        <div class="d-flex justify-content-sm-end mx-5">
            <button class="btn btn-primary mx-2"> <a href="{{ route('sales_invoices.index') }}"
        ...
        <div class="container my-3 max-con">
            ...
            <form id="myForm" class="row  pb-4 brdr" action="{{ route('Services.create.post') }}" method="post">
                ...
                <div class="row table-3 pb-4">
                    <div class="col-md-4 mt-5 ">
                        <div class="mb-3">
                            ...
                            <table class="table table-bordered  table-tafasyel"
                                style="
                            width: 100% !important;
                        ">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 td-ftora">
                                            <input name="code"type="text" class="form-control  my-2 tab-input"
                                                value="Serv {{ $count }}" id="code">
                                            <input name="done" type="text" class="form-control w-75 my-2 tab-input"
                                                value="1" id="done" hidden>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <select class="form-select  form-select-lg my-2" name="id_supplers"
                                                ...
                                                @foreach ($Clients as $Supplier)
                                                    <option value="{{ $Supplier->id }}"
                                                        {{ old('id_supplers') == $Supplier->id ? 'selected' : '' }}>
                                                        {{ $Supplier->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <table class="table table-bordered  table-tafasyel" style="width: 100% !important;">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="4">
                                            <h6 class="my-2 p-1 input-w-custom">تاريخ الإصدار <span class="star">*</span>
                                            </h6>
                                        ...
                                        <td class="px-2 td-ftora">
                                            <select class="form-select  form-select-lg my-2" name="payment_terms"
                                                ...
                                                <optgroup>
                                                    ...
                                                    <option value="0"
                                                        {{ old('payment_terms') == '0' ? 'selected' : '' }}>نفس يوم الاصدار
                                                    </option>
                                                    <option value="7"
                ...
                <div class="col-md-4 my-3 calc d-flex justify-content-around align-content-center ">
                    ...
                    <div>
                        <h2 style="display:none" id="credit_limit_value"><span
                                class="font-size-22 line-height-55">0.00</span></h2>
                        ...
                        <h2><span id=""><input type="text" id="descount_with_premotion"
                                    ...
                                    class="form-custom my-2" value="0.00"></span> </h2>
                ...
                <div class="btn-holder">
                    ...
                    <button class="btn btn-dark mx-2"> <a href="{{ route('sales_invoices.index') }}"
                            class="text-light">رجوع</a></button>
...
@section('script')
    ...
    <script>
        ...
        <span id="errorMessage_${id}" class="error-message">الكمية غير متوافرة</span>`;
            ...
            cell6.innerHTML =
                `<input id="price_unit_product_${id}" onfocusout="result(${id})"   name="test[]" type="text" class="form-control w-100">`;
            cell7.innerHTML =
                `<input id="inc_desc_product_${id}"  type="checkbox" class=" value="off" w-100" onclick="result(${id})">`;
            cell8.innerHTML =
                `<input id="desc_product_${id}"  onfocusout="result(${id})"   name="test[]" type="text" class="form-control w-100" value="0">`;
            ...
            cell0.innerHTML =
                `<input id="price_before_tax_product_${id}"     name="test[]" type="text" class="form-control w-100" readonly>`;
            cell11.innerHTML =
            ...
            cell12.innerHTML =
                `<input id="Tax_value_${id}" value="{{ old('test[]') }}"    name="test[]" type="text" class="form-control w-100 " readonly >`;
            cell13.innerHTML =
                `<input style="width:100%" id="Total_${id}"     name="test[]" type="text" class="form-control w-100" readonly >`;
