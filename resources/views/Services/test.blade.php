            ...
            <!--<div class="row bg-light pb-4 brdr">-->
                ...
                <form id="myForm" class="row  pb-4 brdr" action="{{ route('sales_invoices.create.post') }}" method="post">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> رقم الفاتورة*</label>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between my-3">
                                <label class="mt-3 ml-5">العميل*</label>
                                <select class="form-control w-75 " name="id_supplers" id="Client-select">
                                    <optgroup>
          ...
          <tr> 
           <th class="text-center p-2">${counter}</th>
                ...
                <td class="text-center" colspan="1" style="width: 30px;">
                    ...
                    <input id="inc_input_product_${id}"  name="test[]" class="form-check-input mt-3" type="text" value="off">
                </td>
                <td class="text-center" colspan="2" style="width: 30px;">
...
function checked(index) {
  ...
  $.get(ProductURL, function(data) {
    var qunWithUnit = data.qun / price[2];
    QunChek(data, qunInput, qunWithUnit, errorMessage, qunMessage)

  });
}

function QunChek(data, qunInput, qunWithUnit, errorMessage, qunMessage){
    qunMessage.textContent = "Qun = " + qunWithUnit;
