@extends('layouts.vertical', ['title' => ' شروط الدفع'])
@section('content')
        ...
        <section id="content-wrapper" class="content-header">
            <div class="row">
                  ...
                  <li class="text-primary">
                    <i class="fa fa-angle-double-left mx-2 "></i><a href=""> شروط الدفع</a>
                    </li>
                  </ul>
                  </div>
            ...
            <section>
                <div class="d-flex justify-content-sm-end mx-5 employers">
                    <button class="btn btn-primary mx-2">  <a href="{{ route('PaymentTerms.create') }}" class="text-light">اضافة شروط الدفع</a> <i class="fa-solid fa-plus"></i></button>
                                ...
                                <div class="responsive-scroll">
                                    <table id="dropTable" class="table text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"> شروط دفع </th>
                                            <th scope="col">  عدد الأيام قبل استحقاق الدفع </th>
                ...
                <div class="row bg-light pb-4 brdr">
                    ...
                    <div class="col-md-12 clients ">
                       ...
                       <div>
                           ...
                           <h1 class="my-3">ليس لديك أي شروط دفع</h1>
                           ...
                           <button class="btn btn-primary mx-2 "> <a href="{{ route('PaymentTerms.create') }}" class="text-light">اضافة شروط دفع</a>  <i class="fa-solid fa-plus"></i></button>
                       </div>
...
@section('script')
    ...
    <script>
        ...
        function setdropDatatable() {
            var url = "{{ route('getPaymentTermssData') }}";
