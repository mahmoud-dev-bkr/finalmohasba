@switch($type)
    @case('action')
        <div>
            ...
            <a href="{{ route('PaymentTerms.update',  $PaymentTerms->id) }}"><li><i class="fa-solid fa-pen-to-square"></i></li></a>
            {{-- <li><i class="fa-solid fa-power-off"></i></li> --}}

            <form action="{{ route('PaymentTerms.destroy', $PaymentTerms->id) }}" method="post">
                @csrf
