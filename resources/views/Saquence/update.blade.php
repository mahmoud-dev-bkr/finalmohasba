@extends('layouts.vertical', ['title' => 'تعديل منصب '])
@section('css')
<style>
    .table tr{
        line-height:3;
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="">تعديل منصب</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    <h4 class="mx-4">تعديل صلاحيات</h4>
                </div>
            </div>
                ...
                <form action="{{ route('roles.update',$role->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12" style="background:white;min-height:60vh;">
                        <div class="mt-5 d-flex">
                            ...
                            <input  type="text" name="name" id="{{ $role->id}}" value="{{ $role->name }}"  class="form-control" style="width:300px;margin-right:20px;">
                        </div>
