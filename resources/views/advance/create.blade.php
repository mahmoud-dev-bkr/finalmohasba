@extends('layouts.vertical', ['title' => 'اضافة سلفه'])
@section('content')
<div class="container-fluid">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="advances.html">الخصومات</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-advance.html">سلفه جديد</a>
                    </li>
                </ul>
            </div>
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2"> <a
                    href="{{route('advance.index') }}" class="text-light"> رجوع</a> </button>
        </div>
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12 clients ">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('advance.create.post') }}" method="post">
                            @csrf
                            <div class="form ">
                                    ...
                                    <select class="form-control w-50" name="functionary" id="">
                                        <optgroup>
                                            @foreach ($employe as $employe )
                                                <option value="{{ $employe->id }}">{{ $employe->name_en }}</option>
                                            @endforeach
