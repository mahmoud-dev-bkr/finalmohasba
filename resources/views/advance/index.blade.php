@extends('layouts.vertical', ['title' => 'السلف'])
@section('content')
      <div class="container-fluid">
        ...
        <section id="content-wrapper" class="content-header">
            <div class="row">
                  ...
                  <i class="fa fa-angle-double-left mx-2 "></i><a href="advances.html">السلف</a>
                  </li>
                  </ul>
                  </div>
            ...
            <section>
                <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2">  <a href=""{{ route('advance.create') }}"" class="text-light">خصم جديد</a> <i class="fa-solid fa-plus"></i></button>
                </div>
               <div class="container my-3">
                <div class="row">
                    <div class="col-md-12 hi-mohasba">

                        <h4 class="mx-4">السلف</h4>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="responsive-scroll">
                                    <table id="advanceTable" class="table text-center">
                ...
                <div class="row bg-light pb-4 brdr">
                    ...
                    <div class="col-md-12 clients ">
                       ...
                       <div>
                           <img src="{{ URL('images/advance.svg') }}"  alt="">
                           <h1 class="my-2">ليس لديك أي سلف</h1>
                           <p class="text-secondary my-3 w-75 mx-auto">يتيح لك محاسبة خصم المبالغ المالية من مستحقات الموظفين بتحديد قيمة الخصم ونوعه من مخالفة لقوانين العمل أو حسوم التأمينات الاجتماعية. </p>
                           <button class="btn btn-primary mx-2 "> <a href="{{ route('advance.create') }}" class="text-light"> سلفه جديد</a>  <i class="fa-solid fa-plus"></i></button>
                       </div>
...
@section('script')
    ...
    <script>
        ...
        function setadvanceDatatable() {
            var url = "{{ route('getadvanceData') }}";
