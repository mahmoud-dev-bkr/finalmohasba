@extends('layouts.vertical', ['title' => 'تعديل سلفه'])
@section('content')
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-discount.html">تعديل سلفه </a>
                    </li>
                </ul>
            </div>
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2"> <a
                    href="{{route('discount.index') }}" class="text-light"> رجوع</a> </button>
        </div>
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12 clients ">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('discount.create.post') }}" method="post">
                            @csrf
                            <div class="form ">

                                <div class="d-flex align-content-center justify-content-around">
                                    <label class="mt-3 ml-5">المرجع </label><input type="text"
                                        value="{{$discount->Reference }}" name="Reference"
                                ...
                                <div class="d-flex align-content-center justify-content-around">
                                    <label class="mt-3 ml-5"> القيمة</label><input type="text"
                                        value="{{ $discount->Value }}" name="Value" class="form-control w-50 my-2">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form ">
                            ...
                            <div class="d-flex align-content-center justify-content-around">
                                <label class="mt-3 ">التاريخ </label><input type="date" value="{{ $discount->Date }}"
                                    name="Date" class="form-control w-50 my-2">
                            </div>

                            <div class="d-flex align-content-center justify-content-around">
                                <label class="mt-3 ">الوصف </label><input type="text"
                                    value="{{ $discount->description}}" name="description"
                                    class="form-control w-50 my-2">
                            </div>
