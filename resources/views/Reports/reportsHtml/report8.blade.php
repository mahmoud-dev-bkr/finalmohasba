@extends('layouts.vertical', ['title' => 'تقرير مواقع'])
@section('content')
      ...
      <div class="col-lg-12 mt-3">
        <ul class="d-flex align-content-center">
          ...
          <li class="text-primary">
            <i class="fa fa-angle-double-left mx-2 "></i><a href=""> تقرير مواقع</a>
          </li>
        </ul>
      </div>
      ...
      <div class="row  pb-4 brdr">
        ...
        <div class="col-md-12">
          <div class="w-100 my-5 table-responsive-lg">
            <h3 class="text-center">تقرير مواقع </h3>
            ...
            <table class="table  text-center table-hover table-bordered inventary-table">
              <thead class="cf">
                <tr>
                  <th class="text-center" colspan="2">الرقم التسلسلي</th>
                  <th class="text-center" colspan="4">اسم المنتج</th>
                  <th class="text-center" colspan="1">موقع 1</th>
                  <th class="text-center" colspan="1">المركز الرئيسي</th>
                  <th class="text-center" colspan="1">المجموع</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="text-center" colspan="2">366475823110</td>
                  <td class="text-center" colspan="4">منتج</td>
                  <td class="text-center" colspan="1">100.0</td>
                  <td class="text-center" colspan="1">0</td>
                  <td class="text-center" colspan="1"> 100.0</td>
                </tr>
              </tbody>
            </table>
