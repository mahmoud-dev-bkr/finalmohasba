@extends('layouts.vertical', ['title' => 'فواتير المبيعات الضريبية'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> فواتير المبيعات الضريبية</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12">
                    <div class="w-100 my-5 table-responsive-lg">
                        ...
                        <p class="text-center">لا توجد أية فواتير مبيعات</p>
