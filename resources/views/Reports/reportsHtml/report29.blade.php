@extends('layouts.vertical', ['title' => 'الإشعارات المدينة الضريبية '])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> الإشعارات المدينة الضريبية </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 hi-reports">
                    ...
                    <div class="col-md-9 py-4 main-reports">
                        ...
                        <div class="d-flex justify-content-sm-center product-form pt-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12">
                    <div class="w-100 my-5 table-responsive-lg">
                        <h3 class="text-center"> الإشعارات المدينة الضريبية</h3>
                        <h6 class="text-center my-3">اسم الشركة</h6>
                        <p class="text-center mb-2">الرقم الضريبي: 75984</p>
                        <p class="text-center">لا توجد أية إشعارات للمدين </p>


                        <table class="table site-table text-center table-hover">
                            <thead class="cf site-head">
                                <tr>
                                    <th> مرجع الإشعار المدين</th>
                                    <th> الفاتورة الأصلية</th>
                                    <th>وصف الإشعار المدين</th>
                                    <th>اسم المورد</th>
                                    <th>الرقم الضريبي للمورد</th>
                                    <th>تاريخ الإصدار</th>
                                    <th>تاريخ الاستحقاق</th>
                                    <th> إجمالي الإشعار المدين قبل الضريبة</th>
                                    <th>قيمة الضريبة</th>
                                    <th>مجموع الإشعار المدين</th>

                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>إجمالي الإشعار المدين</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
