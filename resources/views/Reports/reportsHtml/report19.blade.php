@extends('layouts.vertical', ['title' => 'نموذج الإقرار الضريبي '])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> نموذج الإقرار الضريبي</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12 clients">
                    ...
                    اختر التصفية المناسبة للحصول على بيانات التقارير.
                </div>
