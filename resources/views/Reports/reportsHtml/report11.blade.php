@extends('layouts.vertical', ['title' => 'ملخص مستحقات العملاء'])
@section('content')
      ...
      <div class="col-lg-12 mt-3">
        <ul class="d-flex align-content-center">
          ...
          <li class="text-primary">
            <i class="fa fa-angle-double-left mx-2 "></i><a href=""> ملخص مستحقات العملاء</a>
          </li>
        </ul>
      </div>
      ...
      <div class="row bg-light pb-4 brdr">
        ...
        <div class="col-md-12">
          <div class="w-100 my-5 table-responsive-lg">
            <h3 class="text-center">ملخص مستحقات العملاء </h3>
            ...
            <table class="table  table-hover" style="
              ...
              <thead class="cf">
                <tr>
                  ...
                  <th>مبالغ إشعارات دائنة معلقة</th>
              ...
              <tbody>
                <tr>
                  <td data-title="Vendor Name">
                    <a href="/tenant/contacts/1?customer=Customer">mahmoud ashraf</a>
                  </td>
                  <td data-title="Organization">test mohsa</td>
                  <td data-title="Contact No">01126696858</td>
                  <td data-title="Email">medam39@gmail.com</td>
                  <td>0.00 ر.س</td>
                  <td>0.00 ر.س</td>
                  <td>0.00 ر.س</td>
                  <td>0.00 ر.س</td>
                  <td>0.00 ر.س</td>
                  <td data-title="Net Movement">0.00 ر.س</td>
                </tr>
              </tbody>
            </table>
          </div>
