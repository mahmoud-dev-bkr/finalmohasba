@extends('layouts.vertical', ['title' => 'الفواتير الجديدة'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="""> الفواتير الجديدة</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12">
                    <div class="w-100 my-5 table-responsive-lg">
                        <h3 class="text-center"> الفواتير الجديدة</h3>
