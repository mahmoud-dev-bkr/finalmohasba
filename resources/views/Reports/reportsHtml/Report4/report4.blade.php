            ...
            <div class="col-md-12">
                <div class="w-100 my-5 table-responsive-lg">
                    ...
                    <table class="table  table-hover">
                        <thead class="cf">
                            <tr>
                                <th rowspan="2" colspan="8" style="text-align: center;">
                                    الحساب
                                </th>
                        ...
                        <tbody class="stream-append">
                            ...
                            <tr class="reports-total">
                                <td colspan="8" data-title="Account">المجموع</td>
                                <td class="text-center" data-title="Debit">0 ر.س</td>
                                <td class="text-center" data-title="Credit">0 ر.س</td>
                                <td class="text-center" data-title="Debit">{{ $totalFrom }} ر.س</td>
                                <td class="text-center" data-title="Credit">{{ $totalTo }} ر.س</td>
                                <td class="text-center" data-title="Debit">0 ر.س</td>
                                <td class="text-center" data-title="Credit">0 ر.س</td>
                                <td class="text-center" data-title="Debit">0 ر.س</td>
                                <td class="text-center" data-title="Credit">0 ر.س</td>
