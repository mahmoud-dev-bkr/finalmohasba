@extends('layouts.vertical', ['title' => 'فواتير المشتريات  الضريبية'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> فواتير المشتريات الضريبية</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <div class="col-md-12">
                    <div class="w-100 my-5 table-responsive-lg">
                        <h3 class="text-center"> فواتير المشتريات الضريبية</h3>
                        <h6 class="text-center my-3">اسم الشركة</h6>
                        <p class="text-center mb-2">الرقم الضريبي: 75984</p>
                        <p class="text-center">لا توجد أية فواتير مشتريات </p>
