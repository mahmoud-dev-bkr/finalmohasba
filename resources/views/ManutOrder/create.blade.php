...
<div class="container-fluid">
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5">
            <button class="btn btn-primary mx-2"> <a href="manufacturing-orders.html"
                    class="text-light"><a href ="{{ route('ManutOrder.index') }}" ></a>رجوع</a></button>
        </div>
        <div class="container my-3">
            ...
            <form action="{{ route('ManutOrder.create.post') }}" method="post">
                @csrf
                    ...
                    <div class="col-md-8 ">
                        <div class="form my-5 px-5 responsive-scroll">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 w-25">التاريخ</label><input name="Date" type="date"
                                    class="form-control  w-75 my-2">
                            </div>

                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3  w-25">الوصف</label><input name="Des" type="text"
                                    class="form-control w-75 my-2">
                            </div>
