    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary ">
        <div class="container-fluid nav-content">
            <a href="#" class="navbar-brand" id="sidebar-toggle"><i class="fa fa-bars"></i></a> <a class="navbar-brand"
                href="#"> {{ __('basic.welcome') }} <span class="heading"> {{ __('basic.username') }}</span>
                {{ __('basic.in') }} <span class="heading"> {{ __('basic.company_name') }} </span></a>
            <div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link"
                                href="{{ route('change.lang', app()->getLocale() == 'ar' ? 'en' : 'ar') }}"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @foreach ($sites as $site)
                                    <li><a class="dropdown-item"
                                            href="{{ route('change.sites', $site->site_id) }}">{{ $site->site->name_ar }}</a></li>
                                @endforeach
