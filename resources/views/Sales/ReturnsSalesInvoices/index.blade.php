@extends('layouts.vertical', ['title' => 'اشعار دائن'])
@section('content')
      <div class="container-fluid">
                  ...
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="Purchase_orderss.html">اشعار دائن</a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <section>
               <div class="d-flex justify-content-sm-end mx-5">
                    ...
                    <!--{{-- <button class="btn btn-primary mx-2">استيراد قائمة اشعار دائن  -->
                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 PurchaseInvoicess ">
                            <div>
                                ...
                                <h1 class="my-3">ليس لديك أي اشعار دائن</h1>
                                <p class="text-secondary my-5">يوفر محاسبة صفحة محاسبة بالاشعار دائن للمساهمة في تسهيل التعاملات مع العملاء وملخص لبياناتهم.</p>
                                <button class="btn btn-primary mx-2 "> <a href="{{ route('ReturnsSalesInvoices.create') }}" class="text-light">اضافة اشعار دائن</a>  <i class="fa-solid fa-plus"></i></button> <button class="btn btn-primary">استيراد قائمة الاشعار دائن  <i class="fa-solid fa-right-to-bracket mx-1"></i></button>
                            </div>
                        </div>
                    </div>
              @endif
...
@section('script')
    ...
    function reloadData(code,name, status,date,start_date,end_date, site) {
            ...
            // alert(site)
            var url = "{{ route('getReturnsSalesInvoicessData') }}?code=" + code+"&name="+ name +"&status="+ status +"&date="+ date +"&start_date="+ start_date+"&end_date="+ end_date+"&site="+ site;
        ...
        function reset()
        {
            ...
            // $('.barcode-product').val() = ""
            // $('.item-product').val() = ""
            var url = "{{ route('getReturnsSalesInvoicessData') }}"
            PurchaseInvoicesTable.ajax.url(url).load();
        }
