@extends('layouts.vertical', ['title' => 'انشاء عرض وسعر'])
@section('content')
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i>  عرض وسعر 
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> انشاء عرض وسعر</h4>
                </div>
                        ...
                        ">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <input value="{{ $PurchaseInvoices->due_date }}" name="Date_start" type="date"
                                ...
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">
                                    <input value="{{ $PurchaseInvoices->due_date }}" name="Date_end" type="date"
                                ...
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">
                                    <input type="date" value="{{ $PurchaseInvoices->Supply_date }}" name="Date_Groce_Period"
