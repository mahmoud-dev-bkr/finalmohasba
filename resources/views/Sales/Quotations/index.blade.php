                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 PurchaseInvoicess ">
                            <div>
                                ...
                                <p class="text-secondary my-5">يتيح لك محاسبة عمل عرض سعر وهو وثيقة تجارية لعميلك يكون فيها أسعار تقريبية وشروط وأحكام معينة بينك وبين العميل. بعد قبول العميل للعرض بإمكانك تحويله إلى فاتورة بيع بضغطة زر والاستمرار بخطوات إرسال الفاتورة ومتابعة دفعات العميل.</p>
                                <button class="btn btn-primary mx-2 "> <a href="{{ route('Quotation.create') }}" class="text-light">اضافة  عروض واسعار</a>  <i class="fa-solid fa-plus"></i></button>
                            </div>
                        </div>
                    </div>
              @endif
