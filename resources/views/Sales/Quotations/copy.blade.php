@extends('layouts.vertical', ['title' => 'انشاء  عرض و سعر'])
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('Quotation.index') }}">  عرض و سعر</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i>   عرض و سعر 
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> انشاء  عرض و سعر</h4>
                </div>

            </div>
            <div class="row bg-light pb-4 brdr">

                <form class="row bg-light pb-4 brdr" action="{{ route('Quotation.copystore.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
