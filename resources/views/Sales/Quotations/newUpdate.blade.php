@extends('layouts.vertical', ['title' => 'تعديل عرض وسعر'])
@section('content')
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> تعديل عرض وسعر</h4>
                </div>

            </div>
            <!--<div class="row bg-light pb-4 brdr">-->

                <form id="myForm" class="row  pb-4 brdr" action="{{ route('Quotation.edit', $PurchaseInvoices->id) }}" method="post">
