@extends('layouts.vertical', ['title' => 'انشاء فاتورة مبيعات'])
@section('content')
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> انشاء فاتورة مبيعات</h4>
                </div>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input value="{{ $PurchaseInvoices->Date_start }}" name="Date_start" type="date" class="form-control w-75 my-2" id="Date_start_id" >
                                </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
       ...
       @foreach ($QuotationDetails as $QuotationDetails)
            ...
            cell3.innerHTML  = `<input id="dec_product_${id}"  value="{{ $unit->name }}"    type="text" class="form-control w-100">`;
            ...
            cell8.innerHTML  = `<input id="desc_product_${id}" value="{{ $productQ->descunt ?? 0 }} "  onfocusout="result(${id})"   name="test[]" type="text" class="form-control w-100" value="0">`;
  ...
  submitButton.addEventListener('click', function(event) {
    event.preventDefault(); // Prevent the default form submission
      ...
      if (state == "yes") {
          ...
          alert("هناك حقول فارغة برجاء ملاءه و المحاوله مره اخري")
      }
