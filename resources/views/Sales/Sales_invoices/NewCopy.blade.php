...
<style>
    ...
    .table-3 tr td:nth-child(1),.table-3 tr td:nth-child(3){

      width: 15% !important;

    }
    .table-3 tr td:nth-child(2),.table-3 tr td:nth-child(4){
      width: 35% !important;
    }
</style>
@endsection()
                    ...
                    <div class="row table-3 pb-4">
                        ...
                        ">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="4" >
                                    <h6 class="  my-2 pe-1 input-w-custom"> مندوب مشنريات<span class="star">*</span></h6>
                                  </td>
                                  <td class="px-2 td-ftora">
