                      ...
                      <div class="row  pb-4 ">
                        <div class="col-md-12">
                          <div class="w-100 my-5 table-responsive-lg responsive-scroll">
                            ...
                            <a href="javascript:void()" class="btn btn-primary " title="اضافة منتج جديد" data-toggle="modal" data-target="#examplepopup">+</a>
                            <br>
                            <br>
  ...
  <div class="modal-dialog modal-xl" style="max-width: 90% !important;" role="document">
    <div class="modal-content" style="overflow:scroll;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">إنشاء منتج</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="max-height: 100vh !important;overflow:scroll;">
        
        <div class="table-responsive-lg responsive-scroll">
        ...
        <div class="w-100 my-2 table-responsive-lg responsive-scroll">
            <table  class="table w-100 text-center table-bordered inventary-table" style="width:max-content;">
              <thead class="cf">
                <tr>
        ...
        <div class="col-md-12">
          <div class="w-100 my-5 table-responsive-lg responsive-scroll">
            <table id="add_table2" class="table  text-center table-bordered inventary-table">
              <thead class="cf">
                <tr>
            ...
            <a class="btn btn-primary " id="add_row2">اضافة المزيد</a>
          </div>
        </div>
          ...
          <tr> 
              <th class="text-center p-2">${counter}</th>
                ...
                <td class="text-center p-1">
                    <select id="product_${id}"  onchange="myFunction(${id})" name="test[]"  class="form-control  px-2 tab-input">
                        <optgroup>
                ...
                <td class="text-center">
                    <input id="qun_product_${id}" onfocusout="result(${id})" name="test[]" type="text" class="form-custom my-2 tab-input" value="1" >
                ...
                <td class="text-center">
                    <input type="text" class="form-custom my-2 tab-input" value="0" id="desc_product_${id}" onfocusout="result(${id})"   name="test[]">
                    <select class="form-custom my-2 tab-input" name="test[]" id="desc_product_op_${id}" onchange="result(${id})">
...
function QunChek(data, qunInput, qunWithUnit, errorMessage, qunMessage, index, iderror, site){
    ...
    client_select.append(`<option value="">اختار العميل</option>`);
...
//   });
  ...
  $('#add_row').click(function() {
          ...
          <tr> 
                  <th class="text-center p-2">${counter}</th>
                    <td class="text-center p-1">
                        <select id="product_${id}"  onchange="myFunction(${id})" name="test[]"  class="form-control  px-2">
                            <optgroup>
                                <option  value="">اختر المنتج</option>
                                @foreach ($products as $product )
                                    <option  value="{{ $product->id }}">{{ $product->name_ar  }}</option>
                    ...
                    <td class="text-center">
                        <span  id="qunMessage_${id}"  style="margin-top:25px;"  class="qun-message"></span>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                        ...
                        <select class="form-custom my-2" name="test[]" id="desc_product_op_${id}" onchange="result(${id})">
                            <option value="0">قيمة</option>
                            <option value="1">%</option>
                        </select>
                    </td>
                    ...
                    <td class="text-center">
                        <select class="form-select my-2 form-select-lg" id="product_tax_${id}" onchange="result(${id})"   name="test[]">
                            <option  value="">-</option>
                            <option  value="0">0</option>
                            <option  value="15">15</option>
                        </select>
