@extends('layouts.vertical', ['title' => 'تفاصيل بيانات العميل'])
@section('content')
    <section id="content-wrapper" class="content-header">
        <div class="row">
          ...
          <div class="col-lg-12 mt-3">
            <ul class="d-flex align-content-center">
              ...
              <li><span class="text-dark ml-3">العميل</span></li>
              <li class="text-primary">
                <i class="fa fa-angle-double-left mx-2 "></i><a href="">تفاصيل بيانات العميل</a>
              </li>
      ...
      <section>
        <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2"> <a
              href="{{ route('client.index') }}" class="text-light"> رجوع</a> </button>
        </div>
        <div class="container my-3 max-con">
          <div class="row">
            <div class="col-md-12 hi-mohasba">

              <h4 class="mx-4">تفاصيل بيانات العميل</h4>
            </div>
          ...
          <div class="row bg-light pb-4 brdr" style="overflow-x: auto;">
              ...
              <div class="col-md-6">
                ...
                <div class="d-flex align-items-center justify-content-around">
                  ...
                  <div class="text-secondary fw-bold">
                    ...
                    <p class="be-small mb-5">{{ $Client->phon2 }}  </p>
                    <p class="be-small mb-5">{{ $Client->email }}  </p>
            ...
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                  <h4 class="mx-4">فواتير العميل</h4>
                </div>
                <hr>
                <hr>
                <div class="col-md-12">
