               ...
               <div class="row">
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-dark">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('client.index') }}">العملاء</a>
                        </li>
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i>اضافة عميل
                        </li>
                     </ul>
                  </div>
               </div>
                           ...
                           <form action="{{ route('client.create.post') }}" method="post">
                            @csrf
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">اسم العميل</label><input name="name" type="text"  class="form-control w-75 my-2"  value="{{ old('name') }}"    > 
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">رقم الاتصال الأساسي</label><input name="phon" type="text" class="form-control w-75 my-2"     value="{{ old('phon') }}" >
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                              ...
                              <div class="col-md-6 mt-5 ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="fatora">
                                        <div class="d-flex">
                                            <input type="checkbox" class=" mx-5  my-2" id="copy" onclick="result()"> <span class="bold" > نسخ عنوان الفوترة</span>
                                        </div>
                                        <input  name="street_2" placeholder="اسم الشارع" type="text" class="form-control sub-width m-auto my-2"   id="street-2"> 
                                        <div class="d-flex ">
                                            <input name="city_2" placeholder="مدينة" type="text" class="form-control inp-width  my-2"  id="city-2">
                                            <input name="st_2" placeholder="منطقة" type="text" class="form-control inp-width my-2" id="s-2">
                                        </div>
                                        <div class="d-flex ">
                                            <input name="zip_2" placeholder="الرمز البريدي" type="text" class="form-control inp-width  my-2"  id="zip-2">
                                        </div>
                                        <select aria-placeholder="hi" class="form-control sub-width m-auto" name="cantry_2" id="Country-2">  
                                            <optgroup>
                                                <option value="-1">Select Country</option>
                                                <option value="Afghanistan">Afghanistan</option>
                                                <option value="Albania">Albania</option>
