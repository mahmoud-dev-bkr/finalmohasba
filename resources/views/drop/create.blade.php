                                ...
                                <div class="row bg-light pb-4 brdr">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-7">
                                        ...
                                        <form action="{{ route('drop.create.post') }}" method="post">
                                                @csrf

                                            <div class="d-flex align-content-center justify-content-around">
                                            <label class="mt-3 "> الرقم المرجعي </label><input type="text" name="Ref" class="form-control w-50 my-2">
                                            </div>
                                            ...
                                            <div class="d-flex align-content-center justify-content-around my-3">
                                                ...
                                                <div class="d-flex align-content-center justify-content-around my-3">
                                                   ...
                                                   <div class="d-flex align-content-center justify-content-around">
                                                    <label class="mt-3 ">   من</label><input type="date" name="on" class="form-control w-50 my-2">
                                                    </div>

                                                    <div class="d-flex align-content-center justify-content-around">
                                                        <label class="mt-3 ">   الي</label><input type="date" name="to" class="form-control w-50 my-2">
                                                        </div>
