        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-rewards.html">تعديل مكافئة </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12 clients ">
                            ...
                            <div class="form ">
                                ...
                                <div class="d-flex align-content-center justify-content-around">
                                    <label class="mt-3 ml-5">المرجع </label><input type="text"
                                        value="{{$reward->Reference }}" name="Reference" class="form-control w-50 my-2">
                                </div>
                                ...
                                <div class="d-flex align-content-center justify-content-around">
                                    <label class="mt-3 ml-5"> القيمة</label><input type="text"
                                        value="{{ $reward->Value }}" name="Value" class="form-control w-50 my-2">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form ">
                            ...
                            <div class="d-flex align-content-center justify-content-around">
                                <label class="mt-3 ">التاريخ </label><input type="date" value="{{ $reward->Date }}"
                                    name="Date" class="form-control w-50 my-2">
                            </div>

                            <div class="d-flex align-content-center justify-content-around">
                                <label class="mt-3 ">الوصف </label><input type="text" value="{{ $reward->description}}"
