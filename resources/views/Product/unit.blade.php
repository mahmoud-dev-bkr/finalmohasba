    ...
    <div class="container-fluid">
        ...
        <section>
            ...
            <div class="d-flex justify-content-sm-end mx-5">
                <button class="btn btn-primary mx-2"> <a href="{{ route('Product.create.unit') }}" class="text-light"> انشاء
                        وحدة</a> <i class="fa-solid fa-plus"></i></button>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 ">
                                        ...
                                        <div class="d-flex justify-content-sm-center Product-form">
                                            ...
                                            <input id="code" class="form-control w-25 mx-2 code-product" type="text"
                                                placeholder="الاسم">
        ...
        <div class="row bg-light pb-4 brdr">
            <div class="col-md-12 clients ">
                <div>
                    ...
                    <p class="text-secondary my-5">يوفر محاسبة صفحة خاصة بالوحدات للمساهمة في تسهيل التعاملات مع الوحدات
                        وملخص لبياناتهم.</p>
                    <a href="{{ route('Product.create.unit') }}" class="text-light">
                        <button class="btn btn-primary mx-2 "> اضافة الوحدات <i class="fa-solid fa-plus"></i></button>
                    </a>
                </div>
            </div>
        </div>
