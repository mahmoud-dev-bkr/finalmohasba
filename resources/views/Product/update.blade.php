            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-product.html">تعديل {{ $Product->name_ar }}</a>
                    </li>
                </ul>
            </div>
            ...
            <form action="{{ route('Product.edit', $Product->id) }}" method="post">
                ...
                <div class="row bg-light pb-4 brdr">
                    ...
                    <div class="row form">
                       ...
                       <input type="number" value="1" name="type" id="" hidden>
                             ...
                             <tbody>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <div class="row p-0 m-0 ">
                                           <div class="col-11 p-0 m-0">
                                               <input class="form-control" name="serial_number" value="{{ $Product->serial_number }}" type="text" id="serial_number">
                                           </div>
                                   ...
                                   <td>
                                       <div class="row p-0 m-0">
                                           <div class="col-11 p-0 m-0">
                                               <select class="form-control w-100" name="id_des" value="{{ $Product->id_des }}"  id="id_des">
                                                   <optgroup>
                                                       <option value="0">الصنف الاساسي</option>
                                                       @foreach ($items as $item )
                                                           <option value="{{ $item->id }}" {{ $Product->id_des == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                       @endforeach
                                                   </optgroup>
                                               </select>
                                           </div>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <div class="row p-0 m-0">
                                           <div class="col-11 p-0 m-0">
                                               <select name="id_unit" class="form-control" value="{{ $Product->id_unit }}"   id="set_Unit" onchange="change_unit()">
                                                   <optgroup>
                                                       @foreach ($units as $uint )
                                                       <option value="{{ $uint->id }}" {{ $Product->id_unit == $uint->id ? 'selected' : '' }}>{{ $uint->name }}</option>
                                                       @endforeach 
                                                   </optgroup>
                                               </select>
                                           </div>
                                   ...
                                   <td>
                                       <select class="form-control"  name="account_buy" value="{{ $Product->account_buy }}"   id="account_buy">
                                           <optgroup>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <select name="Tex_Number" value="{{ $Product->Tex_Number }}"   class="form-control" id="Tex_Number">
                                           <optgroup>
                                               <option value="0"  {{ $Product->Tex_Number == 0 ? 'selected' : '' }}>0.0%</option>
                                               <option value="15"  {{ $Product->Tex_Number == 15 ? 'selected' : '' }}>15%</option>
                                           </optgroup>
                                       </select>
                                   </td>
                                   <th>
                                   ...
                                   <td>
                                       <select class="form-control" name="account_sel" value="{{ $Product->account_sel }}"   id="account_sel">
                                           <optgroup>
                              ...
                              <div class="w-100 my-5 ">
                                <table  class="table text-center table-bordered inventary-table ct" style="width:100%;">
                                  ...
                                  <tbody>
                                    ...
                                    <!--</td>-->
                                    <td class="text-center" colspan="1" >
                                        <input type="text" class="form-custom-2 my-2"  name="buy" value="{{ $Product->buy }}"  style="width: 125px;">
                                    </td>
                                    <td class="text-center" colspan="1">
                                        <input   class="form-check-input mt-3" type="checkbox" checked >
                                    </td>
                                    <td class="text-center" colspan="1" >
                                        <input type="text" class="form-custom-2 my-2"  name="sel" value="{{ $Product->sel }}"  style="width: 125px;">
                                    </td>
                                    <td class="text-center" colspan="1">
                                        <input  class="form-check-input mt-3" type="checkbox" checked >
                                    </td>
                                    @foreach($ProductUintPricesMain as $ProductUintPriceMain)
                                        
                                        <td class="text-center" colspan="1" >
                                            <input type="text" class="form-custom-2 my-2"  name="oldprice[]"     value="{{ $ProductUintPriceMain->price }}"     style="width: 125px;" id="price_main_{{$ProductUintPriceMain->site_id}}" onfocusout="resultmain({{$ProductUintPriceMain->site_id}})" >
                                            
                                            <input type="text" class="form-custom-2 my-2"  value="{{ $ProductUintPriceMain->site_id }}"   style="width: 125px;"   id="ids_main_{{$ProductUintPriceMain->site_id}}" hidden >
                                            
                                            <input type="text" class="form-custom-2 my-2"  name="oldids[]"  value="{{ $ProductUintPriceMain->site_id }}-{{ $ProductUintPriceMain->price  }}"   style="width: 125px;"   id="result_main_{{ $ProductUintPriceMain->site_id }}" hidden >
                                        </td>
                                         
                                    @endforeach
                                    <td class="text-center" colspan="1" >
                                        <input type="text" class="form-custom-2 my-2"  name="barCode" value="{{ $Product->barCode }}"  style="width: 200px;" >
                                    </td>
                                  </tbody>
                                </table>
                              </div>
...
<script>
      ...
      document.addEventListener("DOMContentLoaded", function() {
       ...
       @foreach ($ProductUint as $PU)
        ...
        <tr> 
                <td class="text-center" colspan="1">
                    <select name="old[]" class="form-select my-2 form-select-lg " style="display: initial; width: 90%; height: 40px;">
                        <optgroup>
                            @foreach ($units as $uint )
                ...
                <td class="text-center" style="width: 30px;">
                    <input type="text" class="form-custom-2 my-2"  name="old[]"  value="{{ $PU->counter_of_unit }}" style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <select name="" class="form-select my-2 form-select-lg" style="display: initial; width: 90%; height: 40px;">
                        <optgroup>
                ...
                <td class="text-center" colspan="1" >
                    <input type="text" class="form-custom-2 my-2"  name="old[]" value="{{ $PU->price_buy }}"  style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <input name="old[]"  class="form-check-input mt-3" type="checkbox" checked >
                </td>
                <td class="text-center" colspan="1" >
                    <input type="text" class="form-custom-2 my-2"  name="old[]" value="{{ $PU->price_sell }}"  style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <input  class="form-check-input mt-3" type="checkbox" checked >
                </td>
                @foreach($ProductUintPrices as $ProductUintPrice)
                    ${counter += 1}
                    
                        <td class="text-center" colspan="1" >
                            <input type="text" class="form-custom-2 my-2"  name="oldprice[]"  value="{{ $ProductUintPrice->price }}"         style="width: 125px;" id="price_${counter}" onfocusout="result(${counter})">
                            <input type="text" class="form-custom-2 my-2"  value="{{ $ProductUintPrice->site_id }}"   style="width: 125px;" id="ids_${counter}" hidden > 
                            <input type="text" class="form-custom-2 my-2"  name="oldids[]" value="{{ $ProductUintPrice->site_id }}-{{ $ProductUintPrice->price }}"   style="width: 125px;"  id="result_${counter}" hidden > 
                        </td>
                    
                @endforeach
                <td class="text-center" colspan="1" >
                    <input type="text" class="form-custom-2 my-2"  name="old[]" value="{{ $PU->barcode }}"  style="width: 125px;" >
                </td>
                <td class="text-center" colspan="1" >
