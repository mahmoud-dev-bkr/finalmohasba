...
@section('content')
    <div class="container-fluid">
                ...
                <div class="col-lg-12 mt-3">
                    <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                            <i class="fa fa-angle-double-left mx-2 "></i><a href="add-product.html">تعديل
                                {{ $Product->name_ar }}</a>
                        </li>
                    </ul>
                </div>
        ...
        <section>
            <div class="d-flex justify-content-sm-end mx-5"> <a href="{{ route('Product.index') }}"
                    class="btn btn-primary mx-2"> رجوع</a>
            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" onclick="submit_unit()" class="btn btn-primary">
                                                حفظ</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" name="name_ar"
                                                    value="{{ $Product->name_ar }}" type="text">
                                            </td>
                                            <th>
                                                <label for="name_en">
                                                    الاسم الانجليزي
                                            ...
                                            <td>
                                                <input class="form-control" name="name_en"
                                                    value="{{ $Product->name_en }}" type="text">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                                ...
                                                <div class="row p-0 m-0 ">
                                                    <div class="col-11 p-0 m-0">
                                                        <input class="form-control" name="serial_number"
                                                            value="{{ $Product->serial_number }}" type="text"
                                                            id="serial_number">
                                                    </div>
                                                    <div class="col-1 p-0 m-0">
                                                        <div onclick="genSerial_number()" class="btn btn-primary m-0"
                                                            style='float:left;'>
                                            ...
                                            <td>
                                                <div class="row p-0 m-0">
                                                    <div class="col-11 p-0 m-0">
                                                        <select class="form-control w-100" name="id_des"
                                                            value="{{ $Product->id_des }}" id="id_des">
                                                            <optgroup>
                                                                <option value="0">الصنف الاساسي</option>
                                                                @foreach ($items as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ $Product->id_des == $item->id ? 'selected' : '' }}>
                                                                        {{ $item->name }}</option>
                                                                @endforeach
                                                            </optgroup>
                                                        </select>
                                        ...
                                        <tr>
                                                ...
                                                <div class="row p-0 m-0">
                                                    <div class="col-11 p-0 m-0">
                                                        <select name="id_unit" class="form-control"
                                                            value="{{ $Product->id_unit }}" id="set_Unit"
                                                            onchange="change_unit()">
                                                            <optgroup>
                                                                @foreach ($units as $uint)
                                                                    <option value="{{ $uint->id }}"
                                                                        {{ $Product->id_unit == $uint->id ? 'selected' : '' }}>
                                                                        {{ $uint->name }}</option>
                                                                @endforeach
                                                            </optgroup>
                                                        </select>
                                            ...
                                            <td>
                                                <select class="form-control" name="account_buy"
                                                    value="{{ $Product->account_buy }}" id="account_buy">
                                                    <optgroup>
                                                        @foreach ($account1 as $account)
                                                            <option {{ $account->code == '4101' ? 'selected' : '' }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="Tex_Number" value="{{ $Product->Tex_Number }}"
                                                    class="form-control" id="Tex_Number">
                                                    <optgroup>
                                                        <option value="0"
                                                            {{ $Product->Tex_Number == 0 ? 'selected' : '' }}>0.0%</option>
                                                        <option value="15"
                                                            {{ $Product->Tex_Number == 15 ? 'selected' : '' }}>15%</option>
                                                    </optgroup>
                                                </select>
                                            </td>
                                            <th>
                                            ...
                                            <td>
                                                <select class="form-control" name="account_sel"
                                                    value="{{ $Product->account_sel }}" id="account_sel">
                                                    <optgroup>
                                                        @foreach ($account2 as $account)
                                                            <option {{ $account->code == '5101' ? 'selected' : '' }}
                                                                value="{{ $account->id }}">{{ $account->name }}</option>
                                                        @endforeach
                                                    </optgroup>
                                                </select>
                            ...
                            <div class="col-md-12">
                                        ...
                                        <!--<th class="text-center"
                                            ...
                                            <tbody>
                                                ...
                                                <td class="text-center" colspan="1">
                                                    <input type="text" class="form-custom-2 my-2" name="buy"
                                                        value="{{ $Product->buy }}" style="width: 125px;">
                                                </td>
                                                <td class="text-center" colspan="1">
                                                    <input class="form-check-input mt-3" type="checkbox" checked>
                                                </td>
                                                <td class="text-center" colspan="1">
                                                    <input type="text" class="form-custom-2 my-2" name="sel"
                                                        value="{{ $Product->sel }}" style="width: 125px;">
                                                </td>
                                                <td class="text-center" colspan="1">
                                                    <input class="form-check-input mt-3" type="checkbox" checked>
                                                </td>
                                                @foreach ($sites as $si)
                                                    @if ($si->type != 1)
                                                        @php
                                                            $ProductUintPriceMain = App\ProductUintPrices::where(
                                                                'product_id',
                                                                $Product->id,
                                                            )
                                                            ->where('unit_id', $Product->id_unit)
                                                            ->where('site_id', $si->id)
                                                            ->first();
                                                        @endphp
                                                        <td class="text-center" colspan="1">
                                                            <input type="text" class="form-custom-2 my-2"
                                                                name="price[]"
                                                                value="{{ $ProductUintPriceMain->price ?? '' }}"
                                                                style="width: 125px;" id="price_main_{{ $si->id }}"
                                                                onfocusout="resultmain({{ $si->id }})">

                                                            <input type="text" class="form-custom-2 my-2"
                                                                value="{{ $si->id }}" style="width: 125px;"
                                                                id="ids_main_{{ $si->id }}" hidden>

                                                            <input type="text" class="form-custom-2 my-2"
                                                                name="ids[]"
                                                                value="{{ $si->id }}-{{ $ProductUintPriceMain->price ?? '' }}"
                                                                style="width: 125px;"
                                                                id="result_main_{{ $si->id }}" hidden>
                                                        </td>
                                                    @endif
                                                @endforeach
                                                <td class="text-center" colspan="1">
                                                    <input type="text" class="form-custom-2 my-2" name="barCode"
                                                        value="{{ $Product->barCode }}" style="width: 200px;">
                                                </td>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="w-100 my-5 table-responsive-lg responsive-scroll">
                                        <table id="add_table"
                                            class="table  text-center table-bordered inventary-table ct">
                                            <thead class="cf">
                                                <tr>
                ...
                row += `
                    <tr> 
                        ...
                        @foreach ($sites as $si)
                            @if ($si->type != 1)
                                @php
                                    $ProductUintPrice = App\ProductUintPrices::where('product_id', $Product->id)
                                        ->where('unit_id', '!=', $Product->id_unit)
                                        ->where('site_id', $si->id)
                                        ->first();
                                @endphp
