@extends('layouts.vertical', ['title' => 'انشاء ' . $title])
@section('content')
                              ...
                              <div class="w-100 my-5 ">
                                <table  class="table text-center table-bordered inventary-table ct" style="width:100%;">
                                  ...
                                  @foreach($ProductUintPricesMain as $ProductUintPriceMain)
                                        ...
                                        <td class="text-center" colspan="1" >
                                            <input type="text" class="form-custom-2 my-2"  name="price[]"     value="{{ $ProductUintPriceMain->price }}"     style="width: 125px;" id="price_main_{{$ProductUintPriceMain->site_id}}" onfocusout="resultmain({{$ProductUintPriceMain->site_id}})" >
                                            ...
                                            <input type="text" class="form-custom-2 my-2"  name="ids[]"  value="{{ $ProductUintPriceMain->site_id }}-{{ $ProductUintPriceMain->price  }}"   style="width: 125px;"   id="result_main_{{ $ProductUintPriceMain->site_id }}" hidden >
                                        </td>
      ...
      document.addEventListener("DOMContentLoaded", function() {
       ...
       @foreach ($ProductUint as $PU)
        ...
        <tr> 
                ...
                <td class="text-center" style="width: 30px;">
                    <input type="text" class="form-custom-2 my-2"  name="test[]"  value="{{ $PU->counter_of_unit }}" style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <select name="" class="form-select my-2 form-select-lg" style="display: initial; width: 90%; height: 40px;">
                        <optgroup>
                ...
                <td class="text-center" colspan="1" >
                    <input type="text" class="form-custom-2 my-2"  name="test[]" value="{{ $PU->price_buy }}"  style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <input name="test[]"  class="form-check-input mt-3" type="checkbox" checked >
                </td>
                <td class="text-center" colspan="1" >
                    <input type="text" class="form-custom-2 my-2"  name="test[]" value="{{ $PU->price_sell }}"  style="width: 125px;">
                </td>
                <td class="text-center" colspan="1">
                    <input  class="form-check-input mt-3" type="checkbox" checked >
                </td>
                   @foreach($ProductUintPrices as $ProductUintPrice)
                    ${counter += 1}
                        ...
                        <td class="text-center" colspan="1" >
                            ...
                            <input type="text" class="form-custom-2 my-2"  name="ids[]" value="{{ $ProductUintPrice->site_id }}-{{ $ProductUintPrice->price }}"   style="width: 125px;"  id="result_${counter}" hidden > 
                        </td>
