                                    ...
                                    <div class="w-100">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="home" aria-selected="true">معلومات الفرع</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="clint-tab" data-bs-toggle="tab"
                                                    data-bs-target="#clint_map" type="button" role="tab"
                                                    aria-controls="clint" aria-selected="false">
                                                    ملفات الفرع
                                                </button>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="row p-0 m-0">
                                                                            <div class="col-11 p-0 m-0">
                                                                                <input id="input_generate_number"
                                                                                    type="text" name="code"
                                                                                    value="" class="form-control"
                                                                                    placeholder="" required>
                                                                            </div>
                                                                            <div class="col-1 p-0 m-0">
                                                                                <div id="btn_generate_number" onclick="genSerial_number()"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input id="" type="text"
                                                                            name="main_activity" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th> وصف النشاط </th>
                                                                    <td><input id="" type="text"
                                                                            name="Activity_description" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>رأس المال المسجل</th>
                                                                    <td><input id="" type="number"
                                                                            name="Registered_capital" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th>رأس المال المضاف</th>
                                                                    <td><input id="" type="number"
                                                                            name="Added_capital" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>السجل التجاري</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input id="" type="number"
                                                                            name="Human_Resources_License" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th>تاريخه</th>
                                                                    <td><input id="" type="date"
                                                                            name="Human_Resources_License_data"
                                                                            value="" class="form-control"
                                                                            placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td><input id="" type="number"
                                                                            name="FDA_license" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th>تاريخه</th>
                                                                    <td><input id="" type="date"
                                                                            name="FDA_license_data" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>التأمينات الاجتماعية</th>
                                                                    <td><input id="" type="number"
                                                                            name="Social_Insurance" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th>تاريخه</th>
                                                                    <td><input id="" type="date"
                                                                            name="Social_Insurance_data" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>الغرفة التجارية</th>
                                                                    <td><input id="" type="number"
                                                                            name="Chamber_Commerce" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                    <th>تاريخه</th>
                                                                    <td><input id="" type="date"
                                                                            name="Chamber_Commerce_data" value=""
                                                                            class="form-control" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>أخري</th>
                                                    ...
                                                    <div class="responsive-scroll">
                                                        <table class="table text-center clint_">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><input id="" type="text"
                                                                            name="currency1" value=""
                                                                            class="form-control" placeholder="العملة">
                                                                    </td>
                                                                    <td><input id="" type="number"
                                                                            name="number_statement1" value=""
                                                                            class="form-control"
                                                                            placeholder="الرقم البيان"></td>
                                                                    <td><input id="" type="number"
                                                                            name="number_account1" value=""
                                                                            class="form-control" placeholder="رقم الحساب">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><input id="" type="text"
                                                                            name="code1" value=""
                                                                            class="form-control" placeholder="سويفت كود">
                                                                    </td>
                                                                    <td><input id="" type="text"
                                                                            name="address1" value=""
                                                                            class="form-control"
                                                        ...
                                                        <table class="table text-center clint_">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <select id="country" name="Accounts_tree"
                                                                            class="form-control" required>
                                                                            @foreach ($Inventorys as $Inventory)
                                                                                <option value="{{ $Inventory->id }}">
                                                                                    {{ $Inventory->name }}</option>
                                                                    ...
                                                                    <td> <select id="country" name="Payment_accounts"
                                                                            class="form-control" required>
                                                                            @foreach ($Inventorys as $Inventory)
                                                                                <option value="{{ $Inventory->id }}">
                                                                                    {{ $Inventory->name }}</option>
                                                                    ...
                                                                    <td> <select id="country" name="Accounts_tree2"
                                                                            class="form-control" required>
                                                                            @foreach ($Inventorys as $Inventory)
                                                                                <option value="{{ $Inventory->id }}">
                                                                                    {{ $Inventory->name }}</option>
                                            ...
                                            <div class="tab-pane fade" id="clint_map" role="tabpanel"
                                                ...
                                                <div class="container">
                                                    <div class="d-flex justify-content-start">
                                                        <h4 class="text-primary my-5">ملفات الفرع </h4>
                                                    </div>
                                                    <div class="responsive-scroll">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label for="file1"
                                                                            class="mt-3 ml-5 btn btn-primary"><i
                                                                                class="fa fa-upload"></i></label>️
                                                                        <input id="file1"
                                                                            name="file_Commercial_Record" type="file"
                                                                            class="d-none" />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label for="file2"
                                                                            class="mt-3 ml-5 btn btn-primary"><i
                                                                                class="fa fa-upload"></i></label>️
                                                                        <input id="file2"
                                                                            name="file_Municipality_number" type="file"
                                                                            class="d-none" />
                                                                    </td>
                                                                    <td>
                                                                        <label class="mt-3 ml-5 btn btn-success">
...
@section('script')
    ...
    <script>
        function genSerial_number() {
            ...
            document.getElementById("input_generate_number").value = Math.random().toString().slice(2, 14);
