...
<div>
    <ul>
        ...
        <a href="{{ route('DailyAccountingEntries.update', $DailyAccountingEntries->id) }}">
            <li><i class="fa-solid fa-pen-to-square"></i></li>
        </a>
        <li><i class="fa-solid fa-power-off"></i></li>

        <form action="{{ route('DailyAccountingEntries.destroy', $DailyAccountingEntries->id) }}" method="post">
            @csrf
