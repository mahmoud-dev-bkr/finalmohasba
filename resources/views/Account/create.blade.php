                            ...
                            <div class="form ">
                                ...
                                <form action="{{ route('Account.create.post') }}" method="post">
                                    ...
                                    <div class="d-flex align-content-center justify-content-around my-3">
                                        ...
                                        <select class="form-control w-50" name="parent_id" id="parent_id"
                                            onchange="myFunction()">
                                            <optgroup>
                                    ...
                                    <div class="d-flex align-content-center justify-content-around">
                                        <label class="mt-3 ml-5 mx-3">الرمز </label><input type="text"
                                            class="form-control w-50 my-2" name="code" id="code" style="text-align: end;" readonly>
                                    </div>
                                    ...
                                    <input type="text" class="form-control w-50 my-2" name="level" id="level"
                                        value="2" hidden>
            ...
            if (parent_id != 0) {
                $(document).ready(function() {
                    ...
                    $.get(AccountURL, function(data) {
                        ...
                        if (data.parent_id == 0) {
                            code.value = data.code + '' + (data.count_child + 1);
                        } else {
                            if ((data.count_child + 1) < 10) {
                                code.value = data.code + '0' + (data.count_child + 1);
                            } else {
                                code.value = data.code + '' + (data.count_child + 1);
                            }
                        }
