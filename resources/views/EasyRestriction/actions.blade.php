@switch($type)
    @case('action')
        <div>
            ...
            <a href="{{ route('EasyRestriction.update', $EasyRestriction->id) }}"><li><i class="fa-solid fa-pen-to-square"></i></li></a>
            <li><i class="fa-solid fa-power-off"></i></li>

            <form action="{{ route('EasyRestriction.destroy', $EasyRestriction->id) }}" method="post">
                @csrf
