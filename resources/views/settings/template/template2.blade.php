...
<body>
        ...
        <div class="tm_invoice_wrap">
            <div class="tm_invoice tm_style1 tm_radius_0" id="tm_download_section">
                <div class="tm_invoice_in">
                    <div
                        class="tm_flex tm_flex_column_sm tm_justify_between tm_align_center tm_align_start_sm tm_f14 tm_primary_color tm_medium tm_mb5">
                        <p class="tm_m0 tm_f18 tm_bold">Invoice</p>
                        <p class="tm_m0">Invoice Date: 12 July 2022</p>
                        <p class="tm_m0">Invoice No: LL230912</p>
                    </div>
                    <div class="tm_grid_row tm_col_4 tm_padd_20 tm_accent_bg tm_mb25 tm_white_color tm_align_center">
                        ...
                        <div> +01 983 345 213 <br>
                            <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                data-cfemail="690c04080005290a060419080710470a0604">[email&#160;protected]</a>
                        </div>
                        <div> 9 Paul Street, London<br> England EC2A 4NE </div>
                        <div> Visite Our site: www.company.com </div>
                    </div>
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            <p class="tm_mb2"><b class="tm_primary_color">Bill To:</b></p>
                            <p> Lowell H. Dominguez <br> 84 Spilman Street, London <br>+01 654 372 234<br>
                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="cea2a1b9aba2a28ea9a3afa7a2e0ada1a3">[email&#160;protected]</a>
                            </p>
                        </div>
                        <div class="tm_invoice_right tm_text_center">
                            <p class="tm_mb3"><b class="tm_primary_color">Amount Due</b></p>
                            <div
                                class="tm_f30 tm_bold tm_accent_color tm_padd_15 tm_accent_bg_10 tm_border_1 tm_accent_border_20 tm_mb5">
                                $1732 </div>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tm_width_2 tm_semi_bold tm_primary_color tm_border_left">Price
                                            </th>
                                            <th class="tm_width_1 tm_semi_bold tm_primary_color tm_border_left">Qty</th>
                                            <th
                                                class="tm_width_2 tm_semi_bold tm_primary_color tm_border_left tm_text_right">
                                                Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <!-- <td class="tm_width_4 tm_border_left">Six web page designs and three times revision</td> -->
                                            <td class="tm_width_2 tm_border_left">$350</td>
                                            <td class="tm_width_1 tm_border_left">1</td>
                                            <td class="tm_width_2 tm_border_left tm_text_right">$350</td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_3">2. Web Development</td>
                                            <!-- <td class="tm_width_4 tm_border_left">Convert pixel-perfect frontend and make it dynamic</td> -->
                                            <td class="tm_width_2 tm_border_left">$600</td>
                                            <td class="tm_width_1 tm_border_left">1</td>
                                            <td class="tm_width_2 tm_border_left tm_text_right">$600</td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_3">3. App Development</td>
                                            <!-- <td class="tm_width_4 tm_border_left">Android & Ios Application Development</td> -->
                                            <td class="tm_width_2 tm_border_left">$200</td>
                                            <td class="tm_width_1 tm_border_left">2</td>
                                            <td class="tm_width_2 tm_border_left tm_text_right">$400</td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_3">4. Digital Marketing</td>
                                            <!-- <td class="tm_width_4 tm_border_left">Facebook, Youtube and Google Marketing</td> -->
                                            <td class="tm_width_2 tm_border_left">$100</td>
                                            <td class="tm_width_1 tm_border_left">3</td>
                                            <td class="tm_width_2 tm_border_left tm_text_right">$300</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="tm_border_bottom tm_accent_bg_10">
                                            ...
                                            <td class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_text_right">$1732
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"90ba0cad8cf8e284","version":"2025.1.0","r":1,"token":"6f756f02820545e3be40ddc6eb6154c3","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}'
