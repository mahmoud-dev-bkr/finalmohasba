            ...
            <section>
               <div class="d-flex justify-content-sm-end mx-5">
                   @can('create_supplier')
                    ...
                    @endcan
                    <button class="btn btn-primary mx-2">
                        <a href="{{ route('ExportSupplier') }}" class="text-light">تحميل ملف اكسل</a>
                        <i class="fa-solid fa-plus"></i>
                    </button>
                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 clients ">
                            <div>
                                ...
                                <p class="text-secondary my-5">يوفر محاسبة صفحة خاصة بالمورد للمساهمة في تسهيل التعاملات مع المورد وملخص لبياناتهم.</p>
...
@section('script')
    ...
    function reloadData(company,name, email,phone,status) {
        ...
        // status-client  phone-clinet email-client  name-client company-client
            var url = "{{ route('getSuppliersData') }}?company=" + company+"&name="+ name +"&email="+ email +"&phone="+ phone +"&status="+ status;
            SuppliersTable.ajax.url(url).load();
        }
