@extends('layouts.vertical', ['title' => 'تفاصيل بيانات  سند صرف'])
@section('content')
    <section id="content-wrapper" class="content-header">
        <div class="row">
          ...
          <div class="col-lg-12 mt-3">
            <ul class="d-flex align-content-center">
              ...
              <li><span class="text-dark ml-3"><a href="{{ route('Supplierbond.index') }}"> سندات</a>  </span></li> 
      ...
      <section>
        <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2"> <a
              href="{{ route('Supplierbond.index') }}" class="text-light"> رجوع</a> </button>
        </div>
