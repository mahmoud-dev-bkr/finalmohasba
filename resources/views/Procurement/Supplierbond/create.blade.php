@extends('layouts.vertical', ['title' => 'اضافة سندات المورد'])
@section('content')
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> سندات المورد</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href=""> إنشاء سندات المورد </a>
                    </li>
                </ul>
            </div>
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5">
            <button class="btn btn-primary mx-2"> <a href="{{ route('Supplierbond.index') }}" class="text-light">رجوع</a></button>
        </div>
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">

                    <h4 class="mx-4"> إنشاء سندات المورد</h4>
                </div>
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                @endif
                <form id="myForm" class="row bg-light pb-4 brdr" action="{{ route('Supplierbond.create.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                        ...
                        <!--    </div>-->
                        <!--    <div class="d-flex align-content-center justify-content-sm-between my-3">-->
                        <!--        <label class="mt-3 ml-5">الفاتورة الخاص بهذا المورد</label>-->
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                ...
                                <input name="Note" type="text" class="form-control w-75 my-2" value="{{ old('Note') }}">
                            </div>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between my-3">
                                ...
                                <select class="form-control w-75" name="id_supplers" id="Client-select1">
                                    <optgroup>
                                        <option value="">اختر مورد</option>
                                        @foreach ($Clients as $Client)
                                        <option value="{{ $Client->id }}" {{ old('id_supplers') == $Client->id ? 'selected' : '' }}>
                                            {{ $Client->name }}
                                        </option>
                                        @endforeach
                                    </optgroup>
...
var PurchaseInvoiceDetailsTable = null
    ...
    // When the select element changes
        $('#ReturnsSalesInvoices-select1').on('change', function()
        {
            ...
            $.ajax({
                url: '/dashboard/Supplierbond/get', // Replace with the actual endpoint URL that retrieves employees based on a branch ID
                type: 'GET',
    ...
    $(document).ready(function() {
        ...
        $('#Client-select1').on('change', function() {
            ...
            if (ClientId) {
                ...
                $.ajax({
                    url: '/dashboard/getInvolice/with/Supplier', // Replace with the actual endpoint URL that retrieves employees based on a branch ID
                    type: 'GET',
                 ...
                 $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("info-client-email").innerHTML =  response.email1;
