  ...
  <body>
    <div class="page content ar">
        ...
        <div class="col col-xs-12">
          <div class="row">
            ...
            <div class="col col-xs-6 header-info-container">
              <h2 class="invoice-title ar_content">سند صرف</h2>
      ...
      <div class="row pdf-brief">
        <div class="col col-xs-8">
          <div class="brief-contact-item mb5">
            <div class="brief-field-title ar_content">مدفوعة لجهة</div>
            <div class="brief-field-value"> {{ $Client->name }}</div>
          </div>
          <div class="brief-contact-item">السعودية</div>
        </div>
        <div class="col col-xs-4 brief-invoice-container responsive-scroll">
          <table cellpadding="0" class="document-info-wrapper">
            <tbody>
              <tr>
                ...
                <td class="document-info-field-value"> {{ $Clientbonds->code }} </td>
              </tr>
              <tr>
                <td class="document-info-field-title ar_content">
                  <strong>التاريخ:&nbsp;&nbsp;</strong>
                </td>
                <td class="document-info-field-value"> {{ $Clientbonds->Date }} </td>
              </tr>
              <tr>
                <td class="document-info-field-title ar_content">
                  <strong>النوع:&nbsp;&nbsp;</strong>
                </td>
                <td class="document-info-field-value">صرف</td>
              </tr>
              <tr>
                <td class="document-info-field-title ar_content">
                  <strong>الحساب:&nbsp;&nbsp;</strong>
                </td>
                <td class="document-info-field-value"> {{ $account->name }}   </td>
              </tr>
              <tr class="document-amount-container">
                ...
                @if($Clientbonds->status == 1 || $Clientbonds->status == 2)
                    <td class="document-info-field-value">{{  $Clientbonds->Amount }} ر.س</td>
                @else 
                    <td class="document-info-field-value">00.00ر.س</td>
                @endif
              </tr>
              <tr class="document-amount-container">
                <td class="document-info-field-title ar_content">
      ...
      <div class="row pdf-data">
        <div class="col-xs-12 responsive-scroll">
          le
            cellpadding="1"
            cellspacing="5"
            width="100%"
          ...
          >
            ...
            <tbody class="center-align-row">
              ...
              <tr>
                ...
                <td>
                  <strong class="ar_content"> فاتورة مشتريات </strong>
                </td>
              ...
              @elseif ($ClientBondsDitails)
                ...
                @foreach ( $ClientBondsDitails as $CD )
                    @php
                        $Invoice =  App\PurchaseInvoices::where("id", $CD->PurchaseInvoices_id)->first();  
