@extends('layouts.vertical', ['title' => 'انشاء سند مورد'])
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i> انشاء سند مورد
                    </li>
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4">انشاء سند مورد</h4>
            ...
            <div class="row  pb-4 brdr">
                ...
                <form id="myForm" action="{{ route('ReturnsPurchase_Invoices.payment.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                    ...
                    <div class="btn-holder">
                        ...
                        > 
                        <a  href="{{ route('ReturnsPurchase_Invoices.index') }}"
