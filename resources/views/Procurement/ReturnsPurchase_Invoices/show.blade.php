@extends('layouts.vertical', ['title' => 'تفاصيل بيانات اشعار مدينه'])
@section('content')
    <section id="content-wrapper" class="content-header">
        <div class="row">
          ...
          <div class="col-lg-12 mt-3">
            <ul class="d-flex align-content-center">
              ...
              <li><span class="text-dark ml-3"><a href="{{ route('ReturnsPurchase_Invoices.index') }}">اشعارات المدينهه</a>  </span></li> 
              <li class="text-primary">
                <i class="fa fa-angle-double-left mx-2 "></i><a href="">تفاصيل بيانات اشعار مدينه</a>
              </li>
      ...
      <section>
        <div class="d-flex justify-content-sm-end mx-5"><button class="btn btn-primary mx-2"> <a
              href="{{ route('ReturnsPurchase_Invoices.index') }}" class="text-light"> رجوع</a> </button>
        </div>
        <div class="container my-3 max-con">
          <div class="row">
            <div class="col-md-12 hi-mohasba">

              <h4 class="mx-4">تفاصيل بيانات اشعار مدينه</h4>
            </div>
