@extends('layouts.vertical', ['title' => 'تعديل اشعار مدينه'])
@section('content')
@section('css')
...
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li><span class="text-dark ml-3">مشتريات</span></li>
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('ReturnsPurchase_Invoices.index') }}"> اشعار مدينه</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i>  اشعار مدينه 
                    </li>
                </ul>
            </div>
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5">
            <button class="btn btn-primary mx-2"> <a href="{{ route('ReturnsPurchase_Invoices.index', $PurchaseInvoices->id) }}" class="text-light">رجوع</a></button>
        </div>
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">

                    <h4 class="mx-4"> تعديل اشعار مدينه</h4>
                </div>

            </div>
            <!--<div class="row bg-light pb-4 brdr">-->

                <form id="myForm" class="row  pb-4 brdr" action="{{ route('ReturnsPurchase_Invoices.edit', $PurchaseInvoices->id) }}" method="post">
                    ...
                    <div class="row table-3 pb-4">
                        ...
                        ">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="4" >                      
                                    <h6 class="my-2 pe-1 input-w-custom">فاتورة مشتريات الاصلية<span class="star">*</span>
                                    </h6>
                                  </td>
                                  <td class="px-2 td-ftora">
                                    <select  class="form-select  form-select-lg my-2" name="purchase_invoice_id" id="ReturnsSalesInvoices-select1">
                                        <optgroup>
                                            <option value="">اختار</option>
                                            @foreach($invoises_Clients as $invoise_Client )
                                                <option value="{{ $invoise_Client->id  ?? ""}}" {{ $invoiceReturns->id ?? "" == $invoise_Client->id ? 'selected' : ''  }}>{{ $invoise_Client->code }}</option>
                                            @endforeach
                                        </optgroup>
                                    </select>
                                  </td>
                            ...
                            width: 100% !important;width: max-content;
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <h5 id="info-client-tax">{{ $SR->Tax_Number ?? "-"}}</h5>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="3" >                      
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                     ...
                     <div class="btn-holder">
                        ...
                        <button class="btn btn-dark mx-2"> <a href="{{ route('ReturnsSalesInvoices.index') }}" class="text-light">رجوع</a></button>
           ...
           var site          =  document.getElementById("site-id").value;
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#ReturnsSalesInvoices-select1').prop('disabled', false);
                    console.log(response)
