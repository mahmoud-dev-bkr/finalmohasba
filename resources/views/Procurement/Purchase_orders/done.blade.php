        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('Purchase_orders.index') }}"> فاتورة مشتريات</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i>  فاتورة مشتريات 
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> اضافة فاتورة مشتريات</h4>
                </div>

            </div>
            <!--<div class="row bg-light pb-4 brdr">-->

                <form id="myForm" class="row  pb-4 brdr" action="{{ route('Purchase_orders.done.post', $PurchaseInvoices->id) }}" method="post">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">
                                    ...
                                    name="Note"  >
                                      <optgroup>
                                        <option {{ $PurchaseInvoices->description == 'cash' ? 'selected' : '' }}   value="cash">نقدي</option>
                                        <option {{ $PurchaseInvoices->description == 'credit' ? 'selected' : '' }} value="credit" >كريديت</option>
                                    </optgroup>
                                    </select>
                                  </td>
                                </tr>
                        ...
                        ">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <input value="{{ $PurchaseInvoices->Date_start }}" name="Date_start" type="date"
                                    class="form-control my-2" id="Date_start_id">
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="4" >                      
                                ...
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">
                                    <input value="{{ $PurchaseInvoices->Date_end }}" name="Date_end" type="date"
                                    class="form-control my-2" id="date_end_id">
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="4" >                      
                                  ...
                                  <td class="px-2 td-ftora">
                                    <input type="date" value="{{ $PurchaseInvoices->Date_Groce_Period }}" name="Date_Groce_Period"
                                    class="form-control my-2" id="Date_Groce_Period">
                                  </td>
                                </tr>
                            ...
                            width: 100% !important;width: max-content;
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <h5 id="info-client-name">{{ $Supplierr->name ?? '-' }}</h5>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="3" >                      
                                  ...
                                  <td class="px-2 td-ftora">
                                    <h5 id="info-client-phone">{{ $Supplierr->phon ?? '-' }}</h5>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="3" >              
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <h5 id="info-client-email">{{ $Supplierr->city_1 ?? '-' }}</h5>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="3" >              
                                  ...
                                  <td class="px-2 td-ftora">        
                                    <h5 id="info-client-tax">{{ $Supplierr->Tex_Number ?? '-' }}</h5>
                                  </td>
                                </tr>
