      ...
      <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        <li><span  class="text-dark ml-3">الامر شراء</span></li>
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="Purchase_orders.html"> امر شراء</a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <section>
               <div class="d-flex justify-content-sm-end mx-5">
                   @can('create_Purchaseorders')
                    <button class="btn btn-primary mx-2">  
                        <a href="{{ route('Purchase_orders.create') }}"  class="text-light">اضافة  امر شراء</a> 
                    ...
                    <!--{{-- <button class="btn btn-primary mx-2">استيراد قائمة  امر شراء  -->
                    ...
                    <div class="row bg-light pb-4 brdr">
                        <div class="col-md-12 PurchaseInvoicess ">
                            <div>
                                ...
                                <h1 class="my-3">ليس لديك أي  امر شراء</h1>
                                <p class="text-secondary my-5">  يتيح محاسبة عمل أمر شراء وهو وثيقة تجارية يصدرها المسؤول عن المستودع للمورد لطلب كمية من منتج معين. يمكن تحويل الأمر إلى فاتورة شراء عند موافقة المورد.    </p>
                                <button class="btn btn-primary mx-2 "> <a href="{{ route('Purchase_orders.create') }}" class="text-light">اضافة  امر شراء</a>  <i class="fa-solid fa-plus"></i>on>
                            </div>
                        </div>
                    </div>
              @endif
...
@section('script')
    ...
    function reloadData(code,name, status,date,start_date,end_date, site) {
            ...
            // alert(site)
            var url = "{{ route('getPurchase_orderssData') }}?code=" + code+"&name="+ name +"&status="+ status +"&date="+ date +"&start_date="+ start_date+"&end_date="+ end_date+"&site="+ site;
        ...
        function downloadExcel(code,name, status,date,start_date,end_date, site) {
            ...
            const url = '{{ route("ExportPurchase_orders") }}?code=' + code+"&name="+ name +"&status="+ status +"&date="+ date +"&start_date="+ start_date+"&end_date="+ end_date+"&site="+ site;
