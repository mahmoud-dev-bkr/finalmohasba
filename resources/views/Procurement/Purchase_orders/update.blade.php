@extends('layouts.vertical', ['title' => 'تعديل امر شراء'])
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="purchase-orders.html"> امر شراء</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="add-purch-order.html"> تعديل امر شراء </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> تعديل امر شراء</h4>
                </div>

            </div>
            <div class="row bg-light pb-4 brdr">

                <form action="{{ route('Purchase_orders.edit', $Purchase_orders->id) }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> المرجع</label><input value="{{ $Purchase_orders->code }}" name="code" type="text" class="form-control w-75 my-2">
                                </div>

                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">الوصف</label><input value="{{ $Purchase_orders->Note }}" name="description" type="text" class="form-control w-75 my-2">
                                </div>
                                    ...
                                    <select  class="form-control w-75" name="id_supplers"  id="">
                                        <optgroup>
                                            ...
                                            @foreach ($Suppliers as $Supplier )
                                                <option {{ $Purchase_orders->id_supplers == $Supplier->id ? 'selected' : '' }} value="{{ $Supplier->id }}">{{ $Supplier->name }}</option>
                                            @endforeach
                                        </optgroup>
                                    </select>
                                </div>
                                ...
                                <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input value="{{ $Purchase_orders->Date_start }}" name="Date_start" type="date" class="form-control w-75 my-2">
                                </div>
                                ...
                                <select  class="form-control w-75"  name="payment_terms" id="">
                                    <optgroup>
                                        <option {{ $Purchase_orders->payment_terms == 0  ? 'selected' : '' }} value="0">نفس يوم الاصدار</option>
                                        <option {{ $Purchase_orders->payment_terms == 7  ? 'selected' : '' }} value="7">بعد 7 يوم</option>
                                        <option {{ $Purchase_orders->payment_terms == 10 ? 'selected' : '' }} value="10">بعد 10 يوم</option>
                                        <option {{ $Purchase_orders->payment_terms == 30 ? 'selected' : '' }} value="30">بعد 30 يوم</option>
                                        <option {{ $Purchase_orders->payment_terms == 60 ? 'selected' : '' }} value="60">بعد 60 يوم</option>
                                        <option {{ $Purchase_orders->payment_terms == 90 ? 'selected' : '' }} value="90">بعد 90 يوم</option>
                                    </optgroup>
                                </select>
                                </div>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الاستحقاق </label><input value="{{ $Purchase_orders->Date_end }}" name="Date_end" type="date"
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ التوريد </label><input type="date" value="{{ $Purchase_orders->Date_Groce_Period }}" name="Date_Groce_Period"
                                    class="form-control w-75 my-2">
                            </div>
