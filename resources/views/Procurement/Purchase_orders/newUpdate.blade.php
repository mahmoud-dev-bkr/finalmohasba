    ...
    <section>
        ...
        <div class="container my-3 max-con">
            ...
            <!--<div class="row bg-light pb-4 brdr">-->
                ...
                <form id="myForm" class="row  pb-4 brdr" action="{{ route('Purchase_orders.edit', $PurchaseInvoices->id) }}" method="post">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> المرجع</label><input  id="code"  value="{{ $PurchaseInvoices->code   }}" name="code" type="text" class="form-control w-75 my-2">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                ...
                                <select class="form-control w-75" name="Note" >
                                    <optgroup>
                                        <option {{ $PurchaseInvoices->Note == 'نقدي' ? 'selected' : '' }} value="نقدي">نقدي</option>
                                        <option {{ $PurchaseInvoices->Note == 'اجله' ? 'selected' : '' }} value="اجله">اجله</option>
                                    </optgroup>
                                </select>
                            </div>
       ...
       @foreach ($QuotationDetails as $QuotationDetails)
        ...
        <tr> 
           <th class="text-center p-2">${counter}</th>
                ...
                <td class="text-center" colspan="2" style="width: 30px;">
                    ...
                    <select  id="dec_product_${id}" name="old[]"  onchange="resultUnit(${id})"    class="form-custom my-2" >
                        ...
                        @foreach ($productUnit as $pu )
                            ...
                            @endphp
                            <option  value="{{ $pu->price_sell }}-{{ $pu->id }}">{{ $unitPro->name }}</option>
                        @endforeach
                    </select>
                ...
                <td class="text-center" colspan="2" style="width: 30px;">
                    <input type="text" class="form-custom my-2" value="0" id="desc_product_${id}" onfocusout="result(${id})"   name="old[]">
          ...
          <tr> 
           <th class="text-center p-2">${counter}</th>
                ...
                <td class="text-center" colspan="2" style="width: 30px;">
                    ...
                    <select  id="dec_product_${id}"    onchange="resultUnit(${id})"   class="form-custom my-2" >
