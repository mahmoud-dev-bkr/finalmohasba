...
<div class="container-fluid">
    <section id="content-wrapper" class="content-header">اء
        <div class="row">
    ...
    <section>
        ...
        <div class="container my-3 max-con">
            ...
            <div class="row bg-light pb-4 brdr">
                ...
                <form class="row bg-light pb-4 brdr" action="{{ route('Purchase_orders.copystore.post') }}" method="post">
                    @csrf
                    <div class="col-md-6 ">
                        ...
                        <div class="form my-5">
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> المرجع</label><input value="QTE {{$count }} " name="Ref" type="text" class="form-control w-75 my-2">
                            </div>

                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5">الوصف</label><input value="{{ $PurchaseInvoices->description }}" name="description" type="text" class="form-control w-75 my-2">
                            </div>

                            <div class="d-flex align-content-center justify-content-sm-between my-3">
                                    <label class="mt-3 ml-5">المورد</label>
                                    <select  class="form-control w-75" name="client_id"  id="Client-select1">
                                        <optgroup>
                                            <option >اختار مورد</option>
                                            @foreach ($Suppliers as $Supplier )
                                                <option {{ $PurchaseInvoices->client_id == $Supplier->id ? 'selected' : '' }} value="{{ $Supplier->id }}">{{ $Supplier->name }}</option>
                                            @endforeach
                                        </optgroup>
                                    </select>
                            </div>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الإصدار</label><input value="{{ $PurchaseInvoices->Release_Date }}" name="Release_Date" type="date" class="form-control w-75 my-2">
                            </div>
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ الاستحقاق </label><input value="{{ $PurchaseInvoices->due_date }}" name="due_date" type="date"
                            ...
                            <div class="d-flex align-content-center justify-content-sm-between">
                                <label class="mt-3 ml-5"> تاريخ التوريد </label><input type="date" value="{{ $PurchaseInvoices->Supply_date }}" name="Supply_date"
                                    class="form-control w-75 my-2">
                            </div>
                    ...
                    <div class="col-md-6 mt-5 ">
                        ...
                        <div class="mb-3">
                            <div class="sub-head">
                                <h5 class="mx-4"> تفاصيل بيانات المورد </h5>
                            </div>
                            ...
                            <div class="fatora d-flex justify-content-around">
                                ...
                                <div>
                                  ...
                                  <div class="text-secondary">
                                    ...
                                    <h5 id="info-client-phone">{{ $Supplier->number1 }}</h5>
                                    <h5 id="info-client-email">{{ $Supplier->city_1 }}</h5>
                                    <h5 id="info-client-tax">{{ $Supplier->Tex_number }} </h5>
                                </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
           ...
           @foreach ($QuotationDetails as $QuotationDetails)
            ...
            cell4.innerHTML  = `<input id="qun_product_${id}" value="{{ $QuotationDetails->qun }}" onfocusout="result(${id})"    name="test[]" type="text" class="form-control w-100">`;
            
            cell6.innerHTML  = `<input id="price_unit_product_${id}" value="{{ $productQ->sel }}" onfocusout="result(${id})"   name="test[]" type="text" class="form-control w-100">`;
            cell7.innerHTML  = `<input id="inc_desc_product_${id}"  type="checkbox" class=" value="off" w-100" onclick="result(${id})">`;
            cell8.innerHTML  = `<input id="desc_product_${id}" value="{{ $productQ->descunt }} "  onfocusout="result(${id})"   name="test[]" type="text" class="form-control w-100" value="0">`;
            ...
            cell0.innerHTML  = `<input id="price_before_tax_product_${id}"  value="{{ $QuotationDetails->price_before }}"    name="test[]" type="text" class="form-control w-100" readonly>`;
            cell11.innerHTML =
            ...
            cell12.innerHTML = `<input id="Tax_value_${id}"  value="{{ $QuotationDetails->tax_value }}"   name="test[]" type="text" class="form-control w-100" readonly >`;
            cell13.innerHTML = `<input style="width:100%" id="Total_${id}"  value="{{ $QuotationDetails->price_after }}"     name="test[]" type="text" class="form-control w-100" readonly >`;
