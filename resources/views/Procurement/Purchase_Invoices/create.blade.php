@extends('layouts.vertical', ['title' => 'اضافة فاتورة مشتريات'])
@section('css')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('Purchase_Invoices.index') }}"> فواتير مشتريات</a>
                    </li>
                    <li class="text-primary">
                        <i class="fa fa-angle-double-left mx-2 "></i> إنشاء فاتورة مشتريات 
                    </li>
                </ul>
            </div>
        ...
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">
                    ...
                    <h4 class="mx-4"> إنشاء فاتورة مشتريات</h4>
                </div>
                      ...
                      <div class="row table-3 pb-4">
                        ...
                        ">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="4" >                      
                                    <h6 class="  my-2 pe-1 input-w-custom"> مندوب مشتريات<span class="star">*</span></h6>
                                  </td>
                                  <td class="px-2 td-ftora">
        ...
        counter += 1
          ...
          <tr> 
              <th class="text-center p-2">${counter}</th>
                ...
                <td class="text-center">
                    <input id="inc_desc_product_${id}" onclick="result(${id})" class="form-check-input mt-3 tab-input" type="checkbox">
