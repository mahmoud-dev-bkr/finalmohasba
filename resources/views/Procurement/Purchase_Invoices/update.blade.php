@extends('layouts.vertical', ['title' => 'تعديل فاتورة مشتريات'])
@section('content')
@section('css')
...
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <ul class="d-flex align-content-center">
                    ...
                    <li class="text-dark">
                        <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('Purchase_Invoices.index') }}"> فاتورة مشتريات</a>
                    </li>
    ...
    <section>
        <div class="d-flex justify-content-sm-end mx-5">
            <button class="btn btn-primary mx-2"> <a href="{{ route('Purchase_Invoices.index', $PurchaseInvoices->id) }}" class="text-light">رجوع</a></button>
        </div>
        <div class="container my-3 max-con">
            <div class="row">
                <div class="col-md-12 hi-mohasba">

                    <h4 class="mx-4"> تعديل فاتورة مشتريات</h4>
                </div>

            </div>
            <!--<div class="row bg-light pb-4 brdr">-->

                <form id="myForm" class="row  pb-4 brdr" action="{{ route('Purchase_Invoices.edit', $PurchaseInvoices->id) }}" method="post">
