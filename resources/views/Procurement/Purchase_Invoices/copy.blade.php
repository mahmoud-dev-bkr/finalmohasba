@extends('layouts.vertical', ['title' => 'انشاء فاتورة مشنريات'])
@section('css')
    <style>
        .form-custom2 {
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-3">
                    <ul class="d-flex align-content-center">
                        ...
                        <li class="text-dark">
                            <i class="fa fa-angle-double-left mx-2 "></i><a href="{{ route('Purchase_Invoices.index') }}">
                                فاتورة مشنريات</a>
                        </li>
        ...
        <section>
            <div class="d-flex justify-content-sm-end mx-5">
                <button class="btn btn-primary mx-2"> <a href="{{ route('Purchase_Invoices.index') }}"
            ...
            <div class="container my-3 max-con">
                <div class="row">
                    <div class="col-md-12 hi-mohasba">
                        ...
                        <h4 class="mx-4"> انشاء فاتورة مشنريات</h4>
                    </div>

                </div>
                <!--<div class="row bg-light pb-4 brdr">-->

                <form id="myForm" class="row  pb-4 brdr" action="{{ route('Purchase_Invoices.create.post') }}"
                    method="post">
                    ...
                    <div class="row table-3 pb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <table class="table table-bordered  table-tafasyel" style="width: 100% !important;">
                                    <tbody>
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="  my-2 pe-1 input-w-custom">رقم الفاتورة <span
                                                        class="star">*</span></h6>

                                            </td>
                                            <td class="px-2 td-ftora">
                                                <input name="code"type="text" class="form-control  my-2 tab-input"
                                                    value="BIL {{ $count }}" id="code">
                                                <input name="done" type="text"
                                                    class="form-control w-75 my-2 tab-input" value="1" id="done"
                                                    hidden>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="  my-2 pe-1 input-w-custom"> الفرع<span class="star">*</span>
                                                </h6>
                                            </td>
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name="site_id"
                                                    id="site-id" onchange="checkinStore()">

                                                    @foreach ($sites as $site)
                                                        <option value="{{ $site->id }}" {{ $site->id == $PurchaseInvoices->site_id ? 'selected' : '' }}>{{ $site->name_ar }}</option>
                                                    @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2 td-ftora">
                                                <select id="payment_method"
                                                    class="form-select  form-select-lg my-2 tab-input" name="Note"
                                                    onchange="showCreditLimit()">
                                                    <optgroup>
                                                        <option {{ $PurchaseInvoices->Note == 'cash' ? 'selected' : '' }}
                                                            value="cash">نقدي</option>
                                                        <option {{ $PurchaseInvoices->Note == 'credit' ? 'selected' : '' }}
                                                            value="credit">كريديت</option>
                                                    </optgroup>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name="id_supplers"
                                                    id="Client-select1">
                                                    <option value="">اختار المورد</option>
                                                    @foreach ($Suppliers as $Supplier)
                                                        <option value="{{ $Supplier->id }}"
                                                            {{ $PurchaseInvoices->id_supplers == $Supplier->id ? 'selected' : '' }}>
                                                            {{ $Supplier->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="  my-2 pe-1 input-w-custom"> مندوب مشنريات<span
                                                        class="star">*</span></h6>
                                            </td>
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name="id_salesperson"
                                                    id="" onchange="checkinStore()">
                                                    @foreach ($salespersons as $salesperson)
                                                        <option value="{{ $salesperson->id }}"
                                                            {{ $PurchaseInvoices->id_salesperson == $salesperson->id ? 'selected' : '' }}>
                                                            {{ $salesperson->name_ar }}
                                                        </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <table class="table table-bordered  table-tafasyel" style=" width: 100% !important; ">
                                    <tbody>
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="my-2 p-1 input-w-custom">تاريخ الإصدار <span
                                                        class="star">*</span></h6>

                                            </td>
                                            <td class="px-2 td-ftora">
                                                <input type="date" class="form-control my-2" id="Date_start_id"
                                                    name="Date_start" value="{{ old('Date_start', date('Y-m-d')) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                            ...
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name="payment_terms"
                                                    id="day_date">
                                                    <optgroup>
                                                        <option value="">اختار شروط الدفع</option>
                                                        <option value="0"
                                                            {{ old('payment_terms') == '0' ? 'selected' : '' }}>نفس يوم
                                                            الاصدار</option>
                                                        <option value="7"
                                                            {{ old('payment_terms') == '7' ? 'selected' : '' }}>بعد 7 يوم
                                                        </option>
                                                        <option value="10"
                                                            {{ old('payment_terms') == '10' ? 'selected' : '' }}>بعد 10 يوم
                                                        </option>
                                                        <option value="30"
                                                            {{ old('payment_terms') == '30' ? 'selected' : '' }}>بعد 30 يوم
                                                        </option>
                                                        <option value="60"
                                                            {{ old('payment_terms') == '60' ? 'selected' : '' }}>بعد 60 يوم
                                                        </option>
                                                        <option value="90"
                                                            {{ old('payment_terms') == '90' ? 'selected' : '' }}>بعد 90 يوم
                                                        </option>
                                                    </optgroup>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="  my-2 p-1 input-w-custom">تاريخ الاستحقاق <span
                                                        class="star">*</span></h6>
                                            </td>
                                            <td class="px-2 td-ftora">
                                                <input type="date" class="form-control my-2" id="date_end_id"
                                                    name="Date_end" value="{{ old('Date_end', date('Y-m-d')) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                <h6 class="  my-2 p-1 input-w-custom">تاريخ التوريد <span
                                                        class="star">*</span></h6>
                                            </td>
                                            <td class="px-2 td-ftora">
                                                <input type="date" class="form-control my-2" name="Date_Groce_Period"
                                                    id="Date_Groce_Period" value="{{ old('Date_end', date('Y-m-d')) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                            ...
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name=""
                                                    id="">
                                                    <optgroup>
                        ...
                        <div class="col-md-4 mt-5 ">
                            ...
                            <div class="mb-3">
                                ...
                                <table class="table table-bordered table-tafasyel" style="width: 100% !important;width: max-content;">
                                    <tbody>
                                        <tr>
                                            <td colspan="3">
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <h6 class="my-2 p-1 input-w-custom">المهام </h6
                                                    class="my-2 p-1 input-w-custom">
                                            </td>
                                            <td class="px-2 td-ftora">
                                                <select class="form-select  form-select-lg my-2" name=""
                                                    id="">
                    ...
                    <div class="col-md-4 my-3 calc d-flex justify-content-around align-content-center ">
                        ...
                        <div>
                            <h2 style="display:none" id="credit_limit_value"><span
                                    class="font-size-22 line-height-55">{{ $SR->credit_limit }}</span></h2>
                            <h2><span id="total_before">0.00</span> </h2>
                            <h2><span id="tax_value">0.00</span> </h2>
                            <h2><span id="total_after">0.00</span> </h2>
                            <h2><span id=""><input type="text" id="descount_with_premotion"
                                        onfocusout="getSum()" name="descount_with_premotion" style="width:120px"
                                        class="form-custom my-2"
                                        value="{{ $PurchaseInvoices->descount_with_premotion }}"></span> </h2>
                    ...
                    <div class="btn-holder">
                        ...
                        <button class="btn btn-dark mx-2"> <a href="{{ route('Purchase_Invoices.index') }}"
                                class="text-light">رجوع</a></button>
    ...
    <script>
        ...
        function myFunction(id) {
            ...
            $(document).ready(function() {
                ...
                var ProductURL = "/dashboard/getInfoAndQunProduct?product_id=" + product_id + "&site_id=" + site
                    .value;
                $.get(ProductURL, function(data) {
                    ...
                    if (site.value == 10) {
                        ...
                        employeeSelect.append(
                            `<option value="${data.sel}-${data.unit.id}-1">${data.id_unit}</option>`);
                        // console.log(data.productUnits)
                        //
                        $.each(data.productUnits, function(key, value) {
                            employeeSelect.append(
                                `<option value="${value.price_sell}-${value.id_unit}-${value.counter_of_unit}">${value.unitproduct_unit.name}</option>`
                                );
                        });
                        ...
                        $.each(data.prices, function(key, value) {
                            ...
                            employeeSelect.append(
                                `<option value="${value.price}-${value.unit.id}-${value.counter_of_unit}">${value.unit.name}</option>`
                                );
                        });
                    }
                    ...
                    TaxValue.value = (Math.round((parseFloat(price) * Tax.value / 100) * 100) / 100)
                        .toFixed(2);
                ...
                if (ClientId) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            document.getElementById("info-client-name").innerHTML = response
                                .name ?? "-";
                            document.getElementById("info-client-phone").innerHTML = response
                                .phon ?? "-";
                            document.getElementById("info-client-email").innerHTML = response
                                .city_1 ?? "-";
                            document.getElementById("info-client-tax").innerHTML = response
                                .Tex_Number ?? "-";
